...
// InlineResponse20089IpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type InlineResponse20089IpsecPolicies struct {
...
func NewInlineResponse20089IpsecPolicies() *InlineResponse20089IpsecPolicies {
	this := InlineResponse20089IpsecPolicies{}
	return &this
}
...
func (o InlineResponse20089IpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20089IpsecPolicies struct {
	value *InlineResponse20089IpsecPolicies
	isSet bool
}

func (v NullableInlineResponse20089IpsecPolicies) Get() *InlineResponse20089IpsecPolicies {
	return v.value
}

func (v *NullableInlineResponse20089IpsecPolicies) Set(val *InlineResponse20089IpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20089IpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20089IpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20089IpsecPolicies(val *InlineResponse20089IpsecPolicies) *NullableInlineResponse20089IpsecPolicies {
	return &NullableInlineResponse20089IpsecPolicies{value: val, isSet: true}
}

func (v NullableInlineResponse20089IpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20089IpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
