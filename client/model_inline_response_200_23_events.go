...
// InlineResponse20023Events struct for InlineResponse20023Events
type InlineResponse20023Events struct {
	...
	EventData *InlineResponse20023EventData `json:"eventData,omitempty"`
}
...
func NewInlineResponse20023Events() *InlineResponse20023Events {
	this := InlineResponse20023Events{}
	return &this
}
...
func (o *InlineResponse20023Events) GetEventData() InlineResponse20023EventData {
	if o == nil || isNil(o.EventData) {
		var ret InlineResponse20023EventData
		return ret
	}
	return *o.EventData
}
...
// SetEventData gets a reference to the given InlineResponse20023EventData and assigns it to the EventData field.
func (o *InlineResponse20023Events) SetEventData(v InlineResponse20023EventData) {
	o.EventData = &v
}

func (o InlineResponse20023Events) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20023Events struct {
	value *InlineResponse20023Events
	isSet bool
}

func (v NullableInlineResponse20023Events) Get() *InlineResponse20023Events {
	return v.value
}

func (v *NullableInlineResponse20023Events) Set(val *InlineResponse20023Events) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20023Events) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20023Events) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20023Events(val *InlineResponse20023Events) *NullableInlineResponse20023Events {
	return &NullableInlineResponse20023Events{value: val, isSet: true}
}

func (v NullableInlineResponse20023Events) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20023Events) UnmarshalJSON(src []byte) error {
	v.isSet = true
