...
// InlineResponse2002InterfacesWan1 WAN 1 settings.
type InlineResponse2002InterfacesWan1 struct {
...
func NewInlineResponse2002InterfacesWan1() *InlineResponse2002InterfacesWan1 {
	this := InlineResponse2002InterfacesWan1{}
	return &this
}
...
func (o InlineResponse2002InterfacesWan1) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse2002InterfacesWan1 struct {
	value *InlineResponse2002InterfacesWan1
	isSet bool
}

func (v NullableInlineResponse2002InterfacesWan1) Get() *InlineResponse2002InterfacesWan1 {
	return v.value
}

func (v *NullableInlineResponse2002InterfacesWan1) Set(val *InlineResponse2002InterfacesWan1) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse2002InterfacesWan1) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse2002InterfacesWan1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse2002InterfacesWan1(val *InlineResponse2002InterfacesWan1) *NullableInlineResponse2002InterfacesWan1 {
	return &NullableInlineResponse2002InterfacesWan1{value: val, isSet: true}
}

func (v NullableInlineResponse2002InterfacesWan1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse2002InterfacesWan1) UnmarshalJSON(src []byte) error {
	v.isSet = true
