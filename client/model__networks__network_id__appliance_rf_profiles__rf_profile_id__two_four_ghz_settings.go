...
// NetworksNetworkIdApplianceRfProfilesRfProfileIdTwoFourGhzSettings Settings related to 2.4Ghz band
type NetworksNetworkIdApplianceRfProfilesRfProfileIdTwoFourGhzSettings struct {
...
func NewNetworksNetworkIdApplianceRfProfilesRfProfileIdTwoFourGhzSettings() *NetworksNetworkIdApplianceRfProfilesRfProfileIdTwoFourGhzSettings {
	this := NetworksNetworkIdApplianceRfProfilesRfProfileIdTwoFourGhzSettings{}
	return &this
}
...
func (o NetworksNetworkIdApplianceRfProfilesRfProfileIdTwoFourGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableNetworksNetworkIdApplianceRfProfilesRfProfileIdTwoFourGhzSettings struct {
	value *NetworksNetworkIdApplianceRfProfilesRfProfileIdTwoFourGhzSettings
	isSet bool
}

func (v NullableNetworksNetworkIdApplianceRfProfilesRfProfileIdTwoFourGhzSettings) Get() *NetworksNetworkIdApplianceRfProfilesRfProfileIdTwoFourGhzSettings {
	return v.value
}

func (v *NullableNetworksNetworkIdApplianceRfProfilesRfProfileIdTwoFourGhzSettings) Set(val *NetworksNetworkIdApplianceRfProfilesRfProfileIdTwoFourGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworksNetworkIdApplianceRfProfilesRfProfileIdTwoFourGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworksNetworkIdApplianceRfProfilesRfProfileIdTwoFourGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworksNetworkIdApplianceRfProfilesRfProfileIdTwoFourGhzSettings(val *NetworksNetworkIdApplianceRfProfilesRfProfileIdTwoFourGhzSettings) *NullableNetworksNetworkIdApplianceRfProfilesRfProfileIdTwoFourGhzSettings {
	return &NullableNetworksNetworkIdApplianceRfProfilesRfProfileIdTwoFourGhzSettings{value: val, isSet: true}
}

func (v NullableNetworksNetworkIdApplianceRfProfilesRfProfileIdTwoFourGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworksNetworkIdApplianceRfProfilesRfProfileIdTwoFourGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
