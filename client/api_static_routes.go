...
func (r StaticRoutesApiCreateNetworkSwitchStackRoutingStaticRouteRequest) CreateNetworkSwitchStackRoutingStaticRoute(createNetworkSwitchStackRoutingStaticRoute InlineObject135) StaticRoutesApiCreateNetworkSwitchStackRoutingStaticRouteRequest {
...
func (r StaticRoutesApiGetDeviceSwitchRoutingStaticRouteRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return map[string]interface{}
func (a *StaticRoutesApiService) GetDeviceSwitchRoutingStaticRouteExecute(r StaticRoutesApiGetDeviceSwitchRoutingStaticRouteRequest) (map[string]interface{}, *http.Response, error) {
	var (
...
func (r StaticRoutesApiUpdateNetworkSwitchStackRoutingStaticRouteRequest) UpdateNetworkSwitchStackRoutingStaticRoute(updateNetworkSwitchStackRoutingStaticRoute InlineObject136) StaticRoutesApiUpdateNetworkSwitchStackRoutingStaticRouteRequest {
