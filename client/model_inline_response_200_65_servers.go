...
// InlineResponse20065Servers struct for InlineResponse20065Servers
type InlineResponse20065Servers struct {
...
func NewInlineResponse20065Servers() *InlineResponse20065Servers {
	this := InlineResponse20065Servers{}
	return &this
}
...
func (o InlineResponse20065Servers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20065Servers struct {
	value *InlineResponse20065Servers
	isSet bool
}

func (v NullableInlineResponse20065Servers) Get() *InlineResponse20065Servers {
	return v.value
}

func (v *NullableInlineResponse20065Servers) Set(val *InlineResponse20065Servers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20065Servers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20065Servers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20065Servers(val *InlineResponse20065Servers) *NullableInlineResponse20065Servers {
	return &NullableInlineResponse20065Servers{value: val, isSet: true}
}

func (v NullableInlineResponse20065Servers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20065Servers) UnmarshalJSON(src []byte) error {
	v.isSet = true
