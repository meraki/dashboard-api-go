...
**ClientVpnConnections** | Pointer to [**[]InlineResponse20021ClientVpnConnections**](InlineResponse20021ClientVpnConnections.md) | VPN connections associated with the client | [optional] 
...
`func (o *InlineResponse20021) GetClientVpnConnections() []InlineResponse20021ClientVpnConnections`

GetClientVpnConnections returns the ClientVpnConnections field if non-nil, zero value otherwise.

### GetClientVpnConnectionsOk

`func (o *InlineResponse20021) GetClientVpnConnectionsOk() (*[]InlineResponse20021ClientVpnConnections, bool)`
...
`func (o *InlineResponse20021) SetClientVpnConnections(v []InlineResponse20021ClientVpnConnections)`

SetClientVpnConnections sets ClientVpnConnections field to given value.

### HasClientVpnConnections

`func (o *InlineResponse20021) HasClientVpnConnections() bool`

HasClientVpnConnections returns a boolean if a field has been set.

### GetLldp

`func (o *InlineResponse20021) GetLldp() [][]string`

GetLldp returns the Lldp field if non-nil, zero value otherwise.

### GetLldpOk

`func (o *InlineResponse20021) GetLldpOk() (*[][]string, bool)`
...
`func (o *InlineResponse20021) SetLldp(v [][]string)`

SetLldp sets Lldp field to given value.

### HasLldp

`func (o *InlineResponse20021) HasLldp() bool`

HasLldp returns a boolean if a field has been set.

### GetCdp

`func (o *InlineResponse20021) GetCdp() [][]string`

GetCdp returns the Cdp field if non-nil, zero value otherwise.

### GetCdpOk

`func (o *InlineResponse20021) GetCdpOk() (*[][]string, bool)`
...
`func (o *InlineResponse20021) SetCdp(v [][]string)`

SetCdp sets Cdp field to given value.

### HasCdp

`func (o *InlineResponse20021) HasCdp() bool`
