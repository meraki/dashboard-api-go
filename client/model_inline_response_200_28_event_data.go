...
// InlineResponse20028EventData An object containing more data related to the event.
type InlineResponse20028EventData struct {
...
func NewInlineResponse20028EventData() *InlineResponse20028EventData {
	this := InlineResponse20028EventData{}
	return &this
}
...
func (o *InlineResponse20028EventData) SetRadio(v string) {
	o.Radio = &v
}
...
func (o InlineResponse20028EventData) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20028EventData struct {
	value *InlineResponse20028EventData
	isSet bool
}

func (v NullableInlineResponse20028EventData) Get() *InlineResponse20028EventData {
	return v.value
}

func (v *NullableInlineResponse20028EventData) Set(val *InlineResponse20028EventData) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20028EventData) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20028EventData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20028EventData(val *InlineResponse20028EventData) *NullableInlineResponse20028EventData {
	return &NullableInlineResponse20028EventData{value: val, isSet: true}
}

func (v NullableInlineResponse20028EventData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20028EventData) UnmarshalJSON(src []byte) error {
	v.isSet = true
