...
// InlineResponse20016Value1Destination Destination of 'custom' type traffic filter
type InlineResponse20016Value1Destination struct {
...
func NewInlineResponse20016Value1Destination() *InlineResponse20016Value1Destination {
	this := InlineResponse20016Value1Destination{}
	return &this
}
...
func (o InlineResponse20016Value1Destination) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20016Value1Destination struct {
	value *InlineResponse20016Value1Destination
	isSet bool
}

func (v NullableInlineResponse20016Value1Destination) Get() *InlineResponse20016Value1Destination {
	return v.value
}

func (v *NullableInlineResponse20016Value1Destination) Set(val *InlineResponse20016Value1Destination) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20016Value1Destination) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20016Value1Destination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20016Value1Destination(val *InlineResponse20016Value1Destination) *NullableInlineResponse20016Value1Destination {
	return &NullableInlineResponse20016Value1Destination{value: val, isSet: true}
}

func (v NullableInlineResponse20016Value1Destination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20016Value1Destination) UnmarshalJSON(src []byte) error {
	v.isSet = true
