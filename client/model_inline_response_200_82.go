...
func (o *InlineResponse20082) GetPassphrase() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20082) GetPassphraseOk() (*string, bool) {
	if o == nil || isNil(o.Passphrase) {
    return nil, false
	}
...
func (o *InlineResponse20082) HasPassphrase() bool {
	if o != nil && !isNil(o.Passphrase) {
		return true
	}
...
func (o *InlineResponse20082) SetPassphrase(v string) {
	o.Passphrase = &v
}

// GetWifiPersonalNetworkId returns the WifiPersonalNetworkId field value if set, zero value otherwise.
func (o *InlineResponse20082) GetWifiPersonalNetworkId() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20082) GetWifiPersonalNetworkIdOk() (*string, bool) {
	if o == nil || isNil(o.WifiPersonalNetworkId) {
    return nil, false
	}
...
func (o *InlineResponse20082) HasWifiPersonalNetworkId() bool {
	if o != nil && !isNil(o.WifiPersonalNetworkId) {
		return true
	}
...
func (o *InlineResponse20082) SetWifiPersonalNetworkId(v string) {
	o.WifiPersonalNetworkId = &v
}

// GetEmail returns the Email field value if set, zero value otherwise.
func (o *InlineResponse20082) GetEmail() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20082) GetEmailOk() (*string, bool) {
	if o == nil || isNil(o.Email) {
    return nil, false
	}
	return o.Email, true
...
func (o *InlineResponse20082) HasEmail() bool {
	if o != nil && !isNil(o.Email) {
		return true
	}
...
func (o *InlineResponse20082) SetEmail(v string) {
	o.Email = &v
}

// GetExpiresAt returns the ExpiresAt field value if set, zero value otherwise.
func (o *InlineResponse20082) GetExpiresAt() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20082) GetExpiresAtOk() (*string, bool) {
	if o == nil || isNil(o.ExpiresAt) {
    return nil, false
	}
...
func (o *InlineResponse20082) HasExpiresAt() bool {
	if o != nil && !isNil(o.ExpiresAt) {
		return true
	}
...
func (o *InlineResponse20082) SetExpiresAt(v string) {
	o.ExpiresAt = &v
}
