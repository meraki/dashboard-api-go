...
type InlineResponse2014 struct {
	...
	Status *InlineResponse2014Status `json:"status,omitempty"`
	...
	Actions []InlineResponse2014Actions `json:"actions"`
}
...
func (o *InlineResponse2014) GetStatus() InlineResponse2014Status {
	if o == nil || isNil(o.Status) {
		var ret InlineResponse2014Status
		return ret
	}
	return *o.Status
}
...
// SetStatus gets a reference to the given InlineResponse2014Status and assigns it to the Status field.
...
func (o *InlineResponse2014) GetActions() []InlineResponse2014Actions {
	if o == nil {
		var ret []InlineResponse2014Actions
		return ret
	}
