...
// InlineResponse20016Ipv6PrefixAssignments struct for InlineResponse20016Ipv6PrefixAssignments
type InlineResponse20016Ipv6PrefixAssignments struct {
...
func NewInlineResponse20016Ipv6PrefixAssignments() *InlineResponse20016Ipv6PrefixAssignments {
	this := InlineResponse20016Ipv6PrefixAssignments{}
	return &this
}
...
func (o InlineResponse20016Ipv6PrefixAssignments) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20016Ipv6PrefixAssignments struct {
	value *InlineResponse20016Ipv6PrefixAssignments
	isSet bool
}

func (v NullableInlineResponse20016Ipv6PrefixAssignments) Get() *InlineResponse20016Ipv6PrefixAssignments {
	return v.value
}

func (v *NullableInlineResponse20016Ipv6PrefixAssignments) Set(val *InlineResponse20016Ipv6PrefixAssignments) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20016Ipv6PrefixAssignments) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20016Ipv6PrefixAssignments) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20016Ipv6PrefixAssignments(val *InlineResponse20016Ipv6PrefixAssignments) *NullableInlineResponse20016Ipv6PrefixAssignments {
	return &NullableInlineResponse20016Ipv6PrefixAssignments{value: val, isSet: true}
}

func (v NullableInlineResponse20016Ipv6PrefixAssignments) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20016Ipv6PrefixAssignments) UnmarshalJSON(src []byte) error {
	v.isSet = true
