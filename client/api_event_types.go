...
func (r EventTypesApiGetNetworkEventsEventTypesRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
...
func (a *EventTypesApiService) GetNetworkEventsEventTypesExecute(r EventTypesApiGetNetworkEventsEventTypesRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
