...
// InlineResponse20022ClientVpnConnections struct for InlineResponse20022ClientVpnConnections
type InlineResponse20022ClientVpnConnections struct {
...
func NewInlineResponse20022ClientVpnConnections() *InlineResponse20022ClientVpnConnections {
	this := InlineResponse20022ClientVpnConnections{}
	return &this
}
...
func (o InlineResponse20022ClientVpnConnections) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20022ClientVpnConnections struct {
	value *InlineResponse20022ClientVpnConnections
	isSet bool
}

func (v NullableInlineResponse20022ClientVpnConnections) Get() *InlineResponse20022ClientVpnConnections {
	return v.value
}

func (v *NullableInlineResponse20022ClientVpnConnections) Set(val *InlineResponse20022ClientVpnConnections) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20022ClientVpnConnections) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20022ClientVpnConnections) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20022ClientVpnConnections(val *InlineResponse20022ClientVpnConnections) *NullableInlineResponse20022ClientVpnConnections {
	return &NullableInlineResponse20022ClientVpnConnections{value: val, isSet: true}
}

func (v NullableInlineResponse20022ClientVpnConnections) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20022ClientVpnConnections) UnmarshalJSON(src []byte) error {
	v.isSet = true
