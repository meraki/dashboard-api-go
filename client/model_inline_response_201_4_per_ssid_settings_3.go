...
// InlineResponse2014PerSsidSettings3 Settings for SSID 3
type InlineResponse2014PerSsidSettings3 struct {
	// Name of SSID
...
func NewInlineResponse2014PerSsidSettings3() *InlineResponse2014PerSsidSettings3 {
	this := InlineResponse2014PerSsidSettings3{}
	return &this
}
...
func (o InlineResponse2014PerSsidSettings3) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse2014PerSsidSettings3 struct {
	value *InlineResponse2014PerSsidSettings3
	isSet bool
}

func (v NullableInlineResponse2014PerSsidSettings3) Get() *InlineResponse2014PerSsidSettings3 {
	return v.value
}

func (v *NullableInlineResponse2014PerSsidSettings3) Set(val *InlineResponse2014PerSsidSettings3) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse2014PerSsidSettings3) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse2014PerSsidSettings3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse2014PerSsidSettings3(val *InlineResponse2014PerSsidSettings3) *NullableInlineResponse2014PerSsidSettings3 {
	return &NullableInlineResponse2014PerSsidSettings3{value: val, isSet: true}
}

func (v NullableInlineResponse2014PerSsidSettings3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse2014PerSsidSettings3) UnmarshalJSON(src []byte) error {
	v.isSet = true
