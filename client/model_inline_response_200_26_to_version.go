...
// InlineResponse20026ToVersion Version to downgrade to (if the network has firmware flexibility)
type InlineResponse20026ToVersion struct {
...
func NewInlineResponse20026ToVersion() *InlineResponse20026ToVersion {
	this := InlineResponse20026ToVersion{}
	return &this
}
...
func (o InlineResponse20026ToVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20026ToVersion struct {
	value *InlineResponse20026ToVersion
	isSet bool
}

func (v NullableInlineResponse20026ToVersion) Get() *InlineResponse20026ToVersion {
	return v.value
}

func (v *NullableInlineResponse20026ToVersion) Set(val *InlineResponse20026ToVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20026ToVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20026ToVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20026ToVersion(val *InlineResponse20026ToVersion) *NullableInlineResponse20026ToVersion {
	return &NullableInlineResponse20026ToVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20026ToVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20026ToVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
