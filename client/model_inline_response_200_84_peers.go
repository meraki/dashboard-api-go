...
// InlineResponse20084Peers struct for InlineResponse20084Peers
type InlineResponse20084Peers struct {
...
func (o InlineResponse20084Peers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20084Peers struct {
	value *InlineResponse20084Peers
	isSet bool
}

func (v NullableInlineResponse20084Peers) Get() *InlineResponse20084Peers {
	return v.value
}

func (v *NullableInlineResponse20084Peers) Set(val *InlineResponse20084Peers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20084Peers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20084Peers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20084Peers(val *InlineResponse20084Peers) *NullableInlineResponse20084Peers {
	return &NullableInlineResponse20084Peers{value: val, isSet: true}
}

func (v NullableInlineResponse20084Peers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20084Peers) UnmarshalJSON(src []byte) error {
	v.isSet = true
