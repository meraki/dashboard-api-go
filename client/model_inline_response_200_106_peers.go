...
// InlineResponse200106Peers struct for InlineResponse200106Peers
type InlineResponse200106Peers struct {
	...
	IpsecPolicies *InlineResponse200106IpsecPolicies `json:"ipsecPolicies,omitempty"`
...
func NewInlineResponse200106Peers() *InlineResponse200106Peers {
	this := InlineResponse200106Peers{}
...
func (o *InlineResponse200106Peers) GetIpsecPolicies() InlineResponse200106IpsecPolicies {
	if o == nil || isNil(o.IpsecPolicies) {
		var ret InlineResponse200106IpsecPolicies
		return ret
	}
...
// SetIpsecPolicies gets a reference to the given InlineResponse200106IpsecPolicies and assigns it to the IpsecPolicies field.
...
func (o InlineResponse200106Peers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200106Peers struct {
	value *InlineResponse200106Peers
	isSet bool
}

func (v NullableInlineResponse200106Peers) Get() *InlineResponse200106Peers {
	return v.value
}

func (v *NullableInlineResponse200106Peers) Set(val *InlineResponse200106Peers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200106Peers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200106Peers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200106Peers(val *InlineResponse200106Peers) *NullableInlineResponse200106Peers {
	return &NullableInlineResponse200106Peers{value: val, isSet: true}
}

func (v NullableInlineResponse200106Peers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200106Peers) UnmarshalJSON(src []byte) error {
	v.isSet = true
