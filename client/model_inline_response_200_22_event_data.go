...
// InlineResponse20022EventData An object containing more data related to the event.
type InlineResponse20022EventData struct {
...
func NewInlineResponse20022EventData() *InlineResponse20022EventData {
	this := InlineResponse20022EventData{}
	return &this
}
...
func (o *InlineResponse20022EventData) SetRadio(v string) {
	o.Radio = &v
}
...
func (o InlineResponse20022EventData) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20022EventData struct {
	value *InlineResponse20022EventData
	isSet bool
}

func (v NullableInlineResponse20022EventData) Get() *InlineResponse20022EventData {
	return v.value
}

func (v *NullableInlineResponse20022EventData) Set(val *InlineResponse20022EventData) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20022EventData) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20022EventData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20022EventData(val *InlineResponse20022EventData) *NullableInlineResponse20022EventData {
	return &NullableInlineResponse20022EventData{value: val, isSet: true}
}

func (v NullableInlineResponse20022EventData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20022EventData) UnmarshalJSON(src []byte) error {
	v.isSet = true
