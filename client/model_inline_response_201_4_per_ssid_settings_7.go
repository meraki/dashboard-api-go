...
// InlineResponse2014PerSsidSettings7 Settings for SSID 7
type InlineResponse2014PerSsidSettings7 struct {
	// Name of SSID
...
func NewInlineResponse2014PerSsidSettings7() *InlineResponse2014PerSsidSettings7 {
	this := InlineResponse2014PerSsidSettings7{}
	return &this
}
...
func (o InlineResponse2014PerSsidSettings7) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse2014PerSsidSettings7 struct {
	value *InlineResponse2014PerSsidSettings7
	isSet bool
}

func (v NullableInlineResponse2014PerSsidSettings7) Get() *InlineResponse2014PerSsidSettings7 {
	return v.value
}

func (v *NullableInlineResponse2014PerSsidSettings7) Set(val *InlineResponse2014PerSsidSettings7) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse2014PerSsidSettings7) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse2014PerSsidSettings7) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse2014PerSsidSettings7(val *InlineResponse2014PerSsidSettings7) *NullableInlineResponse2014PerSsidSettings7 {
	return &NullableInlineResponse2014PerSsidSettings7{value: val, isSet: true}
}

func (v NullableInlineResponse2014PerSsidSettings7) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse2014PerSsidSettings7) UnmarshalJSON(src []byte) error {
	v.isSet = true
