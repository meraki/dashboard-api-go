...
type InlineResponse20041 struct {
	...
	LocalStatusPage *InlineResponse20041LocalStatusPage `json:"localStatusPage,omitempty"`
	SecurePort *InlineResponse20041SecurePort `json:"securePort,omitempty"`
	Fips *InlineResponse20041Fips `json:"fips,omitempty"`
	NamedVlans *InlineResponse20041NamedVlans `json:"namedVlans,omitempty"`
	ClientPrivacy *InlineResponse20041ClientPrivacy `json:"clientPrivacy,omitempty"`
}
...
func (o *InlineResponse20041) GetLocalStatusPage() InlineResponse20041LocalStatusPage {
	if o == nil || isNil(o.LocalStatusPage) {
		var ret InlineResponse20041LocalStatusPage
		return ret
	}
...
// SetLocalStatusPage gets a reference to the given InlineResponse20041LocalStatusPage and assigns it to the LocalStatusPage field.
...
func (o *InlineResponse20041) GetFips() InlineResponse20041Fips {
	if o == nil || isNil(o.Fips) {
		var ret InlineResponse20041Fips
		return ret
	}
	return *o.Fips
}
...
// SetFips gets a reference to the given InlineResponse20041Fips and assigns it to the Fips field.
...
func (o *InlineResponse20041) GetNamedVlans() InlineResponse20041NamedVlans {
	if o == nil || isNil(o.NamedVlans) {
		var ret InlineResponse20041NamedVlans
		return ret
	}
	return *o.NamedVlans
}
...
// SetNamedVlans gets a reference to the given InlineResponse20041NamedVlans and assigns it to the NamedVlans field.
...
func (o *InlineResponse20041) GetClientPrivacy() InlineResponse20041ClientPrivacy {
	if o == nil || isNil(o.ClientPrivacy) {
		var ret InlineResponse20041ClientPrivacy
		return ret
	}
...
// SetClientPrivacy gets a reference to the given InlineResponse20041ClientPrivacy and assigns it to the ClientPrivacy field.
