...
// InlineResponse200111ResultingNetwork Network after the combination
type InlineResponse200111ResultingNetwork struct {
	// Network ID
...
func NewInlineResponse200111ResultingNetwork() *InlineResponse200111ResultingNetwork {
	this := InlineResponse200111ResultingNetwork{}
	return &this
}
...
func (o *InlineResponse200111ResultingNetwork) GetTags() []string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse200111ResultingNetwork) GetUrlOk() (*string, bool) {
	if o == nil || isNil(o.Url) {
    return nil, false
	}
	return o.Url, true
...
func (o InlineResponse200111ResultingNetwork) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200111ResultingNetwork struct {
	value *InlineResponse200111ResultingNetwork
	isSet bool
}

func (v NullableInlineResponse200111ResultingNetwork) Get() *InlineResponse200111ResultingNetwork {
	return v.value
}

func (v *NullableInlineResponse200111ResultingNetwork) Set(val *InlineResponse200111ResultingNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200111ResultingNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200111ResultingNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200111ResultingNetwork(val *InlineResponse200111ResultingNetwork) *NullableInlineResponse200111ResultingNetwork {
	return &NullableInlineResponse200111ResultingNetwork{value: val, isSet: true}
}

func (v NullableInlineResponse200111ResultingNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200111ResultingNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
