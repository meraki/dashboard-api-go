...
// InlineResponse20021BandwidthLimitsWan2 uplink wan2 configured limits [optional]
type InlineResponse20021BandwidthLimitsWan2 struct {
...
func NewInlineResponse20021BandwidthLimitsWan2() *InlineResponse20021BandwidthLimitsWan2 {
	this := InlineResponse20021BandwidthLimitsWan2{}
	return &this
}
...
func (o InlineResponse20021BandwidthLimitsWan2) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20021BandwidthLimitsWan2 struct {
	value *InlineResponse20021BandwidthLimitsWan2
	isSet bool
}

func (v NullableInlineResponse20021BandwidthLimitsWan2) Get() *InlineResponse20021BandwidthLimitsWan2 {
	return v.value
}

func (v *NullableInlineResponse20021BandwidthLimitsWan2) Set(val *InlineResponse20021BandwidthLimitsWan2) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20021BandwidthLimitsWan2) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20021BandwidthLimitsWan2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20021BandwidthLimitsWan2(val *InlineResponse20021BandwidthLimitsWan2) *NullableInlineResponse20021BandwidthLimitsWan2 {
	return &NullableInlineResponse20021BandwidthLimitsWan2{value: val, isSet: true}
}

func (v NullableInlineResponse20021BandwidthLimitsWan2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20021BandwidthLimitsWan2) UnmarshalJSON(src []byte) error {
	v.isSet = true
