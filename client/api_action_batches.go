...
func (r ActionBatchesApiCreateOrganizationActionBatchRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *ActionBatchesApiService) CreateOrganizationActionBatchExecute(r ActionBatchesApiCreateOrganizationActionBatchRequest) (map[string]interface{}, *http.Response, error) {
	var (
...
func (r ActionBatchesApiGetOrganizationActionBatchRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return map[string]interface{}
func (a *ActionBatchesApiService) GetOrganizationActionBatchExecute(r ActionBatchesApiGetOrganizationActionBatchRequest) (map[string]interface{}, *http.Response, error) {
	var (
