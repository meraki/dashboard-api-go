...
func (r AccessPoliciesApiCreateNetworkSwitchAccessPolicyRequest) CreateNetworkSwitchAccessPolicy(createNetworkSwitchAccessPolicy InlineObject109) AccessPoliciesApiCreateNetworkSwitchAccessPolicyRequest {
	r.createNetworkSwitchAccessPolicy = &createNetworkSwitchAccessPolicy
	return r
}

func (r AccessPoliciesApiCreateNetworkSwitchAccessPolicyRequest) Execute() (*InlineResponse20059, *http.Response, error) {
...
func (a *AccessPoliciesApiService) CreateNetworkSwitchAccessPolicyExecute(r AccessPoliciesApiCreateNetworkSwitchAccessPolicyRequest) (*InlineResponse20059, *http.Response, error) {
	var (
...
func (r AccessPoliciesApiGetNetworkSwitchAccessPoliciesRequest) Execute() ([]InlineResponse20059, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20059
func (a *AccessPoliciesApiService) GetNetworkSwitchAccessPoliciesExecute(r AccessPoliciesApiGetNetworkSwitchAccessPoliciesRequest) ([]InlineResponse20059, *http.Response, error) {
	var (
...
func (r AccessPoliciesApiGetNetworkSwitchAccessPolicyRequest) Execute() (*InlineResponse20059, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20059
func (a *AccessPoliciesApiService) GetNetworkSwitchAccessPolicyExecute(r AccessPoliciesApiGetNetworkSwitchAccessPolicyRequest) (*InlineResponse20059, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AccessPoliciesApiUpdateNetworkSwitchAccessPolicyRequest) UpdateNetworkSwitchAccessPolicy(updateNetworkSwitchAccessPolicy InlineObject110) AccessPoliciesApiUpdateNetworkSwitchAccessPolicyRequest {
	r.updateNetworkSwitchAccessPolicy = &updateNetworkSwitchAccessPolicy
	return r
}

func (r AccessPoliciesApiUpdateNetworkSwitchAccessPolicyRequest) Execute() (*InlineResponse20059, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20059
func (a *AccessPoliciesApiService) UpdateNetworkSwitchAccessPolicyExecute(r AccessPoliciesApiUpdateNetworkSwitchAccessPolicyRequest) (*InlineResponse20059, *http.Response, error) {
	var (
