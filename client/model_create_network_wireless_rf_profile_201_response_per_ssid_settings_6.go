...
// CreateNetworkWirelessRfProfile201ResponsePerSsidSettings6 Settings for SSID 6
type CreateNetworkWirelessRfProfile201ResponsePerSsidSettings6 struct {
	// Name of SSID
...
func NewCreateNetworkWirelessRfProfile201ResponsePerSsidSettings6() *CreateNetworkWirelessRfProfile201ResponsePerSsidSettings6 {
	this := CreateNetworkWirelessRfProfile201ResponsePerSsidSettings6{}
	return &this
}
...
func (o CreateNetworkWirelessRfProfile201ResponsePerSsidSettings6) MarshalJSON() ([]byte, error) {
...
type NullableCreateNetworkWirelessRfProfile201ResponsePerSsidSettings6 struct {
	value *CreateNetworkWirelessRfProfile201ResponsePerSsidSettings6
	isSet bool
}

func (v NullableCreateNetworkWirelessRfProfile201ResponsePerSsidSettings6) Get() *CreateNetworkWirelessRfProfile201ResponsePerSsidSettings6 {
	return v.value
}

func (v *NullableCreateNetworkWirelessRfProfile201ResponsePerSsidSettings6) Set(val *CreateNetworkWirelessRfProfile201ResponsePerSsidSettings6) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateNetworkWirelessRfProfile201ResponsePerSsidSettings6) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateNetworkWirelessRfProfile201ResponsePerSsidSettings6) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateNetworkWirelessRfProfile201ResponsePerSsidSettings6(val *CreateNetworkWirelessRfProfile201ResponsePerSsidSettings6) *NullableCreateNetworkWirelessRfProfile201ResponsePerSsidSettings6 {
	return &NullableCreateNetworkWirelessRfProfile201ResponsePerSsidSettings6{value: val, isSet: true}
}

func (v NullableCreateNetworkWirelessRfProfile201ResponsePerSsidSettings6) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateNetworkWirelessRfProfile201ResponsePerSsidSettings6) UnmarshalJSON(src []byte) error {
	v.isSet = true
