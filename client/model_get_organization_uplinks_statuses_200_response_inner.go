...
type GetOrganizationUplinksStatuses200ResponseInner struct {
	...
	HighAvailability *GetOrganizationUplinksStatuses200ResponseInnerHighAvailability `json:"highAvailability,omitempty"`
	// Uplinks
...
func (o *GetOrganizationUplinksStatuses200ResponseInner) GetHighAvailability() GetOrganizationUplinksStatuses200ResponseInnerHighAvailability {
	if o == nil || IsNil(o.HighAvailability) {
		var ret GetOrganizationUplinksStatuses200ResponseInnerHighAvailability
		return ret
	}
...
// SetHighAvailability gets a reference to the given GetOrganizationUplinksStatuses200ResponseInnerHighAvailability and assigns it to the HighAvailability field.
