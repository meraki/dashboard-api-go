...
// InlineResponse20094IpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type InlineResponse20094IpsecPolicies struct {
...
func NewInlineResponse20094IpsecPolicies() *InlineResponse20094IpsecPolicies {
	this := InlineResponse20094IpsecPolicies{}
	return &this
}
...
func (o InlineResponse20094IpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20094IpsecPolicies struct {
	value *InlineResponse20094IpsecPolicies
	isSet bool
}

func (v NullableInlineResponse20094IpsecPolicies) Get() *InlineResponse20094IpsecPolicies {
	return v.value
}

func (v *NullableInlineResponse20094IpsecPolicies) Set(val *InlineResponse20094IpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20094IpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20094IpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20094IpsecPolicies(val *InlineResponse20094IpsecPolicies) *NullableInlineResponse20094IpsecPolicies {
	return &NullableInlineResponse20094IpsecPolicies{value: val, isSet: true}
}

func (v NullableInlineResponse20094IpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20094IpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
