...
// checks if the CreateDeviceLiveToolsPing201ResponseCallback type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateDeviceLiveToolsPing201ResponseCallback{}

// CreateDeviceLiveToolsPing201ResponseCallback Information for callback used to send back results
type CreateDeviceLiveToolsPing201ResponseCallback struct {
...
func NewCreateDeviceLiveToolsPing201ResponseCallback() *CreateDeviceLiveToolsPing201ResponseCallback {
	this := CreateDeviceLiveToolsPing201ResponseCallback{}
	return &this
}
...
func (o CreateDeviceLiveToolsPing201ResponseCallback) MarshalJSON() ([]byte, error) {
...
func (o CreateDeviceLiveToolsPing201ResponseCallback) ToMap() (map[string]interface{}, error) {
...
type NullableCreateDeviceLiveToolsPing201ResponseCallback struct {
	value *CreateDeviceLiveToolsPing201ResponseCallback
	isSet bool
}

func (v NullableCreateDeviceLiveToolsPing201ResponseCallback) Get() *CreateDeviceLiveToolsPing201ResponseCallback {
	return v.value
}

func (v *NullableCreateDeviceLiveToolsPing201ResponseCallback) Set(val *CreateDeviceLiveToolsPing201ResponseCallback) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateDeviceLiveToolsPing201ResponseCallback) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateDeviceLiveToolsPing201ResponseCallback) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateDeviceLiveToolsPing201ResponseCallback(val *CreateDeviceLiveToolsPing201ResponseCallback) *NullableCreateDeviceLiveToolsPing201ResponseCallback {
	return &NullableCreateDeviceLiveToolsPing201ResponseCallback{value: val, isSet: true}
}

func (v NullableCreateDeviceLiveToolsPing201ResponseCallback) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateDeviceLiveToolsPing201ResponseCallback) UnmarshalJSON(src []byte) error {
	v.isSet = true
