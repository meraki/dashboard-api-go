...
func (r LogsApiGetOrganizationWebhooksLogsRequest) Execute() ([]InlineResponse200133, *http.Response, error) {
...
func (a *LogsApiService) GetOrganizationWebhooksLogsExecute(r LogsApiGetOrganizationWebhooksLogsRequest) ([]InlineResponse200133, *http.Response, error) {
	var (
