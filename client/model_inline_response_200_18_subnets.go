...
// InlineResponse20018Subnets struct for InlineResponse20018Subnets
type InlineResponse20018Subnets struct {
...
func NewInlineResponse20018Subnets() *InlineResponse20018Subnets {
	this := InlineResponse20018Subnets{}
	return &this
}
...
func (o InlineResponse20018Subnets) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20018Subnets struct {
	value *InlineResponse20018Subnets
	isSet bool
}

func (v NullableInlineResponse20018Subnets) Get() *InlineResponse20018Subnets {
	return v.value
}

func (v *NullableInlineResponse20018Subnets) Set(val *InlineResponse20018Subnets) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20018Subnets) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20018Subnets) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20018Subnets(val *InlineResponse20018Subnets) *NullableInlineResponse20018Subnets {
	return &NullableInlineResponse20018Subnets{value: val, isSet: true}
}

func (v NullableInlineResponse20018Subnets) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20018Subnets) UnmarshalJSON(src []byte) error {
	v.isSet = true
