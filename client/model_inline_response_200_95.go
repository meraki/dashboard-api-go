...
type InlineResponse20095 struct {
	Counts *InlineResponse20095Counts `json:"counts,omitempty"`
}
...
func (o *InlineResponse20095) GetCounts() InlineResponse20095Counts {
	if o == nil || isNil(o.Counts) {
		var ret InlineResponse20095Counts
		return ret
	}
	return *o.Counts
}
...
// SetCounts gets a reference to the given InlineResponse20095Counts and assigns it to the Counts field.
