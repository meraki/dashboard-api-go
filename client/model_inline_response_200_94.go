...
type InlineResponse20094 struct {
	Usage *InlineResponse20094Usage `json:"usage,omitempty"`
	Counts *InlineResponse20094Counts `json:"counts,omitempty"`
}
...
func (o *InlineResponse20094) GetUsage() InlineResponse20094Usage {
	if o == nil || isNil(o.Usage) {
		var ret InlineResponse20094Usage
		return ret
	}
	return *o.Usage
}
...
// SetUsage gets a reference to the given InlineResponse20094Usage and assigns it to the Usage field.
...
func (o *InlineResponse20094) GetCounts() InlineResponse20094Counts {
	if o == nil || isNil(o.Counts) {
		var ret InlineResponse20094Counts
		return ret
	}
	return *o.Counts
}
...
// SetCounts gets a reference to the given InlineResponse20094Counts and assigns it to the Counts field.
