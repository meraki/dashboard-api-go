...
// InlineResponse20017PerformanceClass Performance class setting for uplink preference rule
type InlineResponse20017PerformanceClass struct {
...
func NewInlineResponse20017PerformanceClass(type_ string) *InlineResponse20017PerformanceClass {
	this := InlineResponse20017PerformanceClass{}
	this.Type = type_
	return &this
}
...
func (o InlineResponse20017PerformanceClass) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20017PerformanceClass struct {
	value *InlineResponse20017PerformanceClass
	isSet bool
}

func (v NullableInlineResponse20017PerformanceClass) Get() *InlineResponse20017PerformanceClass {
	return v.value
}

func (v *NullableInlineResponse20017PerformanceClass) Set(val *InlineResponse20017PerformanceClass) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20017PerformanceClass) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20017PerformanceClass) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20017PerformanceClass(val *InlineResponse20017PerformanceClass) *NullableInlineResponse20017PerformanceClass {
	return &NullableInlineResponse20017PerformanceClass{value: val, isSet: true}
}

func (v NullableInlineResponse20017PerformanceClass) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20017PerformanceClass) UnmarshalJSON(src []byte) error {
	v.isSet = true
