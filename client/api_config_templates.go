...
func (r ConfigTemplatesApiGetOrganizationConfigTemplateSwitchProfilesRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return []map[string]interface{}
func (a *ConfigTemplatesApiService) GetOrganizationConfigTemplateSwitchProfilesExecute(r ConfigTemplatesApiGetOrganizationConfigTemplateSwitchProfilesRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
