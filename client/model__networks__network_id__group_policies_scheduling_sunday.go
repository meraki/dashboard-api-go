...
// NetworksNetworkIdGroupPoliciesSchedulingSunday The schedule object for Sunday.
type NetworksNetworkIdGroupPoliciesSchedulingSunday struct {
...
func NewNetworksNetworkIdGroupPoliciesSchedulingSunday() *NetworksNetworkIdGroupPoliciesSchedulingSunday {
	this := NetworksNetworkIdGroupPoliciesSchedulingSunday{}
	return &this
}
...
func (o NetworksNetworkIdGroupPoliciesSchedulingSunday) MarshalJSON() ([]byte, error) {
...
type NullableNetworksNetworkIdGroupPoliciesSchedulingSunday struct {
	value *NetworksNetworkIdGroupPoliciesSchedulingSunday
	isSet bool
}

func (v NullableNetworksNetworkIdGroupPoliciesSchedulingSunday) Get() *NetworksNetworkIdGroupPoliciesSchedulingSunday {
	return v.value
}

func (v *NullableNetworksNetworkIdGroupPoliciesSchedulingSunday) Set(val *NetworksNetworkIdGroupPoliciesSchedulingSunday) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworksNetworkIdGroupPoliciesSchedulingSunday) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworksNetworkIdGroupPoliciesSchedulingSunday) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworksNetworkIdGroupPoliciesSchedulingSunday(val *NetworksNetworkIdGroupPoliciesSchedulingSunday) *NullableNetworksNetworkIdGroupPoliciesSchedulingSunday {
	return &NullableNetworksNetworkIdGroupPoliciesSchedulingSunday{value: val, isSet: true}
}

func (v NullableNetworksNetworkIdGroupPoliciesSchedulingSunday) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworksNetworkIdGroupPoliciesSchedulingSunday) UnmarshalJSON(src []byte) error {
	v.isSet = true
