...
// InlineResponse20084IpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type InlineResponse20084IpsecPolicies struct {
...
func NewInlineResponse20084IpsecPolicies() *InlineResponse20084IpsecPolicies {
	this := InlineResponse20084IpsecPolicies{}
	return &this
}
...
func (o InlineResponse20084IpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20084IpsecPolicies struct {
	value *InlineResponse20084IpsecPolicies
	isSet bool
}

func (v NullableInlineResponse20084IpsecPolicies) Get() *InlineResponse20084IpsecPolicies {
	return v.value
}

func (v *NullableInlineResponse20084IpsecPolicies) Set(val *InlineResponse20084IpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20084IpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20084IpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20084IpsecPolicies(val *InlineResponse20084IpsecPolicies) *NullableInlineResponse20084IpsecPolicies {
	return &NullableInlineResponse20084IpsecPolicies{value: val, isSet: true}
}

func (v NullableInlineResponse20084IpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20084IpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
