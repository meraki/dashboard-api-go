...
// InlineResponse20016Value1Source Source of 'custom' type traffic filter
type InlineResponse20016Value1Source struct {
...
func NewInlineResponse20016Value1Source() *InlineResponse20016Value1Source {
	this := InlineResponse20016Value1Source{}
	return &this
}
...
func (o InlineResponse20016Value1Source) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20016Value1Source struct {
	value *InlineResponse20016Value1Source
	isSet bool
}

func (v NullableInlineResponse20016Value1Source) Get() *InlineResponse20016Value1Source {
	return v.value
}

func (v *NullableInlineResponse20016Value1Source) Set(val *InlineResponse20016Value1Source) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20016Value1Source) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20016Value1Source) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20016Value1Source(val *InlineResponse20016Value1Source) *NullableInlineResponse20016Value1Source {
	return &NullableInlineResponse20016Value1Source{value: val, isSet: true}
}

func (v NullableInlineResponse20016Value1Source) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20016Value1Source) UnmarshalJSON(src []byte) error {
	v.isSet = true
