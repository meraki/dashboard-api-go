...
type GetOrganizationApplianceVpnVpnFirewallRules200Response struct {
	...
	Rules []GetOrganizationApplianceVpnVpnFirewallRules200ResponseRulesInner `json:"rules,omitempty"`
}
...
func (o *GetOrganizationApplianceVpnVpnFirewallRules200Response) GetRules() []GetOrganizationApplianceVpnVpnFirewallRules200ResponseRulesInner {
	if o == nil || IsNil(o.Rules) {
		var ret []GetOrganizationApplianceVpnVpnFirewallRules200ResponseRulesInner
		return ret
	}
	return o.Rules
}
...
// SetRules gets a reference to the given []GetOrganizationApplianceVpnVpnFirewallRules200ResponseRulesInner and assigns it to the Rules field.
