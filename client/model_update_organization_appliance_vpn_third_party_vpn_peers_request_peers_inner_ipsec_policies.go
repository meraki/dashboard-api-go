...
// UpdateOrganizationApplianceVpnThirdPartyVPNPeersRequestPeersInnerIpsecPolicies Custom IPSec policies for the VPN peer. If not included and a preset has not been chosen, the default preset for IPSec policies will be used.
type UpdateOrganizationApplianceVpnThirdPartyVPNPeersRequestPeersInnerIpsecPolicies struct {
...
func NewUpdateOrganizationApplianceVpnThirdPartyVPNPeersRequestPeersInnerIpsecPolicies() *UpdateOrganizationApplianceVpnThirdPartyVPNPeersRequestPeersInnerIpsecPolicies {
	this := UpdateOrganizationApplianceVpnThirdPartyVPNPeersRequestPeersInnerIpsecPolicies{}
	return &this
}
...
func (o UpdateOrganizationApplianceVpnThirdPartyVPNPeersRequestPeersInnerIpsecPolicies) MarshalJSON() ([]byte, error) {
...
type NullableUpdateOrganizationApplianceVpnThirdPartyVPNPeersRequestPeersInnerIpsecPolicies struct {
	value *UpdateOrganizationApplianceVpnThirdPartyVPNPeersRequestPeersInnerIpsecPolicies
	isSet bool
}

func (v NullableUpdateOrganizationApplianceVpnThirdPartyVPNPeersRequestPeersInnerIpsecPolicies) Get() *UpdateOrganizationApplianceVpnThirdPartyVPNPeersRequestPeersInnerIpsecPolicies {
	return v.value
}

func (v *NullableUpdateOrganizationApplianceVpnThirdPartyVPNPeersRequestPeersInnerIpsecPolicies) Set(val *UpdateOrganizationApplianceVpnThirdPartyVPNPeersRequestPeersInnerIpsecPolicies) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateOrganizationApplianceVpnThirdPartyVPNPeersRequestPeersInnerIpsecPolicies) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateOrganizationApplianceVpnThirdPartyVPNPeersRequestPeersInnerIpsecPolicies) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateOrganizationApplianceVpnThirdPartyVPNPeersRequestPeersInnerIpsecPolicies(val *UpdateOrganizationApplianceVpnThirdPartyVPNPeersRequestPeersInnerIpsecPolicies) *NullableUpdateOrganizationApplianceVpnThirdPartyVPNPeersRequestPeersInnerIpsecPolicies {
	return &NullableUpdateOrganizationApplianceVpnThirdPartyVPNPeersRequestPeersInnerIpsecPolicies{value: val, isSet: true}
}

func (v NullableUpdateOrganizationApplianceVpnThirdPartyVPNPeersRequestPeersInnerIpsecPolicies) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateOrganizationApplianceVpnThirdPartyVPNPeersRequestPeersInnerIpsecPolicies) UnmarshalJSON(src []byte) error {
	v.isSet = true
