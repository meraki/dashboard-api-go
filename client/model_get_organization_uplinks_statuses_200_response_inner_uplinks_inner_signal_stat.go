...
// GetOrganizationUplinksStatuses200ResponseInnerUplinksInnerSignalStat Tower Signal Status
type GetOrganizationUplinksStatuses200ResponseInnerUplinksInnerSignalStat struct {
...
func NewGetOrganizationUplinksStatuses200ResponseInnerUplinksInnerSignalStat() *GetOrganizationUplinksStatuses200ResponseInnerUplinksInnerSignalStat {
	this := GetOrganizationUplinksStatuses200ResponseInnerUplinksInnerSignalStat{}
	return &this
}
...
func (o GetOrganizationUplinksStatuses200ResponseInnerUplinksInnerSignalStat) MarshalJSON() ([]byte, error) {
...
type NullableGetOrganizationUplinksStatuses200ResponseInnerUplinksInnerSignalStat struct {
	value *GetOrganizationUplinksStatuses200ResponseInnerUplinksInnerSignalStat
	isSet bool
}

func (v NullableGetOrganizationUplinksStatuses200ResponseInnerUplinksInnerSignalStat) Get() *GetOrganizationUplinksStatuses200ResponseInnerUplinksInnerSignalStat {
	return v.value
}

func (v *NullableGetOrganizationUplinksStatuses200ResponseInnerUplinksInnerSignalStat) Set(val *GetOrganizationUplinksStatuses200ResponseInnerUplinksInnerSignalStat) {
	v.value = val
	v.isSet = true
}

func (v NullableGetOrganizationUplinksStatuses200ResponseInnerUplinksInnerSignalStat) IsSet() bool {
	return v.isSet
}

func (v *NullableGetOrganizationUplinksStatuses200ResponseInnerUplinksInnerSignalStat) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetOrganizationUplinksStatuses200ResponseInnerUplinksInnerSignalStat(val *GetOrganizationUplinksStatuses200ResponseInnerUplinksInnerSignalStat) *NullableGetOrganizationUplinksStatuses200ResponseInnerUplinksInnerSignalStat {
	return &NullableGetOrganizationUplinksStatuses200ResponseInnerUplinksInnerSignalStat{value: val, isSet: true}
}

func (v NullableGetOrganizationUplinksStatuses200ResponseInnerUplinksInnerSignalStat) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetOrganizationUplinksStatuses200ResponseInnerUplinksInnerSignalStat) UnmarshalJSON(src []byte) error {
	v.isSet = true
