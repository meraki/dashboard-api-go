...
// NetworksNetworkIdGroupPoliciesSchedulingMonday The schedule object for Monday.
type NetworksNetworkIdGroupPoliciesSchedulingMonday struct {
...
func NewNetworksNetworkIdGroupPoliciesSchedulingMonday() *NetworksNetworkIdGroupPoliciesSchedulingMonday {
	this := NetworksNetworkIdGroupPoliciesSchedulingMonday{}
	return &this
}
...
func (o NetworksNetworkIdGroupPoliciesSchedulingMonday) MarshalJSON() ([]byte, error) {
...
type NullableNetworksNetworkIdGroupPoliciesSchedulingMonday struct {
	value *NetworksNetworkIdGroupPoliciesSchedulingMonday
	isSet bool
}

func (v NullableNetworksNetworkIdGroupPoliciesSchedulingMonday) Get() *NetworksNetworkIdGroupPoliciesSchedulingMonday {
	return v.value
}

func (v *NullableNetworksNetworkIdGroupPoliciesSchedulingMonday) Set(val *NetworksNetworkIdGroupPoliciesSchedulingMonday) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworksNetworkIdGroupPoliciesSchedulingMonday) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworksNetworkIdGroupPoliciesSchedulingMonday) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworksNetworkIdGroupPoliciesSchedulingMonday(val *NetworksNetworkIdGroupPoliciesSchedulingMonday) *NullableNetworksNetworkIdGroupPoliciesSchedulingMonday {
	return &NullableNetworksNetworkIdGroupPoliciesSchedulingMonday{value: val, isSet: true}
}

func (v NullableNetworksNetworkIdGroupPoliciesSchedulingMonday) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworksNetworkIdGroupPoliciesSchedulingMonday) UnmarshalJSON(src []byte) error {
	v.isSet = true
