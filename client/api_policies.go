...
func (r PoliciesApiGetNetworkPoliciesByClientRequest) Execute() ([]InlineResponse20033, *http.Response, error) {
...
func (a *PoliciesApiService) GetNetworkPoliciesByClientExecute(r PoliciesApiGetNetworkPoliciesByClientRequest) ([]InlineResponse20033, *http.Response, error) {
	var (
