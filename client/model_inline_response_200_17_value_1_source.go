...
// InlineResponse20017Value1Source Source of 'custom' type traffic filter
type InlineResponse20017Value1Source struct {
...
func NewInlineResponse20017Value1Source() *InlineResponse20017Value1Source {
	this := InlineResponse20017Value1Source{}
	return &this
}
...
func (o InlineResponse20017Value1Source) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20017Value1Source struct {
	value *InlineResponse20017Value1Source
	isSet bool
}

func (v NullableInlineResponse20017Value1Source) Get() *InlineResponse20017Value1Source {
	return v.value
}

func (v *NullableInlineResponse20017Value1Source) Set(val *InlineResponse20017Value1Source) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20017Value1Source) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20017Value1Source) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20017Value1Source(val *InlineResponse20017Value1Source) *NullableInlineResponse20017Value1Source {
	return &NullableInlineResponse20017Value1Source{value: val, isSet: true}
}

func (v NullableInlineResponse20017Value1Source) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20017Value1Source) UnmarshalJSON(src []byte) error {
	v.isSet = true
