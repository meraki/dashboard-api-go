...
// InlineResponse2001InterfacesWan2 WAN 2 settings.
type InlineResponse2001InterfacesWan2 struct {
...
func NewInlineResponse2001InterfacesWan2() *InlineResponse2001InterfacesWan2 {
	this := InlineResponse2001InterfacesWan2{}
	return &this
}
...
func (o InlineResponse2001InterfacesWan2) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse2001InterfacesWan2 struct {
	value *InlineResponse2001InterfacesWan2
	isSet bool
}

func (v NullableInlineResponse2001InterfacesWan2) Get() *InlineResponse2001InterfacesWan2 {
	return v.value
}

func (v *NullableInlineResponse2001InterfacesWan2) Set(val *InlineResponse2001InterfacesWan2) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse2001InterfacesWan2) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse2001InterfacesWan2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse2001InterfacesWan2(val *InlineResponse2001InterfacesWan2) *NullableInlineResponse2001InterfacesWan2 {
	return &NullableInlineResponse2001InterfacesWan2{value: val, isSet: true}
}

func (v NullableInlineResponse2001InterfacesWan2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse2001InterfacesWan2) UnmarshalJSON(src []byte) error {
	v.isSet = true
