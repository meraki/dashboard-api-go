...
func Test_client_ByClientApiService(t *testing.T) {
	...
	t.Run("Test ByClientApiService GetOrganizationWirelessDevicesPacketLossByClient", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var organizationId string

		resp, httpRes, err := apiClient.ByClientApi.GetOrganizationWirelessDevicesPacketLossByClient(context.Background(), organizationId).Execute()
