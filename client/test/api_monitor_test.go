...
func Test_client_MonitorApiService(t *testing.T) {
	...
	t.Run("Test MonitorApiService GetOrganizationSummarySwitchPowerHistory", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var organizationId string

		resp, httpRes, err := apiClient.MonitorApi.GetOrganizationSummarySwitchPowerHistory(context.Background(), organizationId).Execute()
	...
	t.Run("Test MonitorApiService GetOrganizationSummaryTopNetworksByStatus", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var organizationId string

		resp, httpRes, err := apiClient.MonitorApi.GetOrganizationSummaryTopNetworksByStatus(context.Background(), organizationId).Execute()
