...
func Test_client_MonitorApiService(t *testing.T) {
	...
	t.Run("Test MonitorApiService GetOrganizationUplinksLossAndLatency", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var organizationId string

		resp, httpRes, err := apiClient.MonitorApi.GetOrganizationUplinksLossAndLatency(context.Background(), organizationId).Execute()
