...
func Test_client_MonitorApiService(t *testing.T) {
    ...
    t.Run("Test MonitorApiService GetOrganizationWebhookLogs", func(t *testing.T) {

        t.Skip("skip test")  // remove to run test

        var organizationId string

        resp, httpRes, err := apiClient.MonitorApi.GetOrganizationWebhookLogs(context.Background(), organizationId).Execute()
