...
func Test_client_WebhooksApiService(t *testing.T) {
	...
	t.Run("Test WebhooksApiService GetOrganizationWebhooksCallbacksStatus", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.WebhooksApi.GetOrganizationWebhooksCallbacksStatus(context.Background(), organizationId, callbackId).Execute()
