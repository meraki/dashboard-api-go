...
func Test_client_InterfacesApiService(t *testing.T) {
    ...
    t.Run("Test InterfacesApiService DeleteDeviceSwitchRoutingInterface", func(t *testing.T) {
        ...
        resp, httpRes, err := apiClient.InterfacesApi.DeleteDeviceSwitchRoutingInterface(context.Background(), serial, interfaceId).Execute()
    ...
    t.Run("Test InterfacesApiService DeleteNetworkSwitchStackRoutingInterface", func(t *testing.T) {
        ...
        resp, httpRes, err := apiClient.InterfacesApi.DeleteNetworkSwitchStackRoutingInterface(context.Background(), networkId, switchStackId, interfaceId).Execute()
