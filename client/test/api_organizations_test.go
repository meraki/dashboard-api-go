...
func Test_client_OrganizationsApiService(t *testing.T) {
    ...
    t.Run("Test OrganizationsApiService GetOrganizationWebhookLogs", func(t *testing.T) {

        t.Skip("skip test")  // remove to run test

        var organizationId string

        resp, httpRes, err := apiClient.OrganizationsApi.GetOrganizationWebhookLogs(context.Background(), organizationId).Execute()
