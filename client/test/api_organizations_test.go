...
func Test_client_OrganizationsApiService(t *testing.T) {
	...
	t.Run("Test OrganizationsApiService GetOrganizationUplinksLossAndLatency", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var organizationId string

		resp, httpRes, err := apiClient.OrganizationsApi.GetOrganizationUplinksLossAndLatency(context.Background(), organizationId).Execute()
