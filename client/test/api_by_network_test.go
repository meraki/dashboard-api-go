...
func Test_client_ByNetworkApiService(t *testing.T) {
	...
	t.Run("Test ByNetworkApiService GetOrganizationSmSentryPoliciesAssignmentsByNetwork", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var organizationId string

		resp, httpRes, err := apiClient.ByNetworkApi.GetOrganizationSmSentryPoliciesAssignmentsByNetwork(context.Background(), organizationId).Execute()
	...
	t.Run("Test ByNetworkApiService GetOrganizationWirelessDevicesPacketLossByNetwork", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var organizationId string

		resp, httpRes, err := apiClient.ByNetworkApi.GetOrganizationWirelessDevicesPacketLossByNetwork(context.Background(), organizationId).Execute()
