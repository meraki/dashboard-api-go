...
func Test_client_SummaryApiService(t *testing.T) {
	...
	t.Run("Test SummaryApiService GetOrganizationSummaryTopNetworksByStatus", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var organizationId string

		resp, httpRes, err := apiClient.SummaryApi.GetOrganizationSummaryTopNetworksByStatus(context.Background(), organizationId).Execute()
