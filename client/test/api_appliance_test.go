...
func Test_client_ApplianceApiService(t *testing.T) {
    ...
    t.Run("Test ApplianceApiService DeleteNetworkAppliancePrefixesDelegatedStatic", func(t *testing.T) {
        ...
        resp, httpRes, err := apiClient.ApplianceApi.DeleteNetworkAppliancePrefixesDelegatedStatic(context.Background(), networkId, staticDelegatedPrefixId).Execute()
    ...
    t.Run("Test ApplianceApiService DeleteNetworkApplianceRfProfile", func(t *testing.T) {
        ...
        resp, httpRes, err := apiClient.ApplianceApi.DeleteNetworkApplianceRfProfile(context.Background(), networkId, rfProfileId).Execute()
    ...
    t.Run("Test ApplianceApiService DeleteNetworkApplianceStaticRoute", func(t *testing.T) {
        ...
        resp, httpRes, err := apiClient.ApplianceApi.DeleteNetworkApplianceStaticRoute(context.Background(), networkId, staticRouteId).Execute()
    ...
    t.Run("Test ApplianceApiService DeleteNetworkApplianceTrafficShapingCustomPerformanceClass", func(t *testing.T) {
        ...
        resp, httpRes, err := apiClient.ApplianceApi.DeleteNetworkApplianceTrafficShapingCustomPerformanceClass(context.Background(), networkId, customPerformanceClassId).Execute()
    ...
    t.Run("Test ApplianceApiService DeleteNetworkApplianceVlan", func(t *testing.T) {
        ...
        resp, httpRes, err := apiClient.ApplianceApi.DeleteNetworkApplianceVlan(context.Background(), networkId, vlanId).Execute()
