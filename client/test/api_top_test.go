...
func Test_client_TopApiService(t *testing.T) {
	...
	t.Run("Test TopApiService GetOrganizationSummaryTopNetworksByStatus", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		var organizationId string

		resp, httpRes, err := apiClient.TopApi.GetOrganizationSummaryTopNetworksByStatus(context.Background(), organizationId).Execute()
