...
func Test_client_CameraApiService(t *testing.T) {
    ...
    t.Run("Test CameraApiService DeleteNetworkCameraQualityRetentionProfile", func(t *testing.T) {
        ...
        resp, httpRes, err := apiClient.CameraApi.DeleteNetworkCameraQualityRetentionProfile(context.Background(), networkId, qualityRetentionProfileId).Execute()
    ...
    t.Run("Test CameraApiService DeleteNetworkCameraWirelessProfile", func(t *testing.T) {
        ...
        resp, httpRes, err := apiClient.CameraApi.DeleteNetworkCameraWirelessProfile(context.Background(), networkId, wirelessProfileId).Execute()
    ...
    t.Run("Test CameraApiService DeleteOrganizationCameraCustomAnalyticsArtifact", func(t *testing.T) {
        ...
        resp, httpRes, err := apiClient.CameraApi.DeleteOrganizationCameraCustomAnalyticsArtifact(context.Background(), organizationId, artifactId).Execute()
