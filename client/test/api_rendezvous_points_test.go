...
func Test_client_RendezvousPointsApiService(t *testing.T) {
    ...
    t.Run("Test RendezvousPointsApiService DeleteNetworkSwitchRoutingMulticastRendezvousPoint", func(t *testing.T) {
        ...
        resp, httpRes, err := apiClient.RendezvousPointsApi.DeleteNetworkSwitchRoutingMulticastRendezvousPoint(context.Background(), networkId, rendezvousPointId).Execute()
