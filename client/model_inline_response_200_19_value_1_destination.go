...
// InlineResponse20019Value1Destination Destination of 'custom' type traffic filter
type InlineResponse20019Value1Destination struct {
...
func NewInlineResponse20019Value1Destination() *InlineResponse20019Value1Destination {
	this := InlineResponse20019Value1Destination{}
	return &this
}
...
func (o InlineResponse20019Value1Destination) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20019Value1Destination struct {
	value *InlineResponse20019Value1Destination
	isSet bool
}

func (v NullableInlineResponse20019Value1Destination) Get() *InlineResponse20019Value1Destination {
	return v.value
}

func (v *NullableInlineResponse20019Value1Destination) Set(val *InlineResponse20019Value1Destination) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20019Value1Destination) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20019Value1Destination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20019Value1Destination(val *InlineResponse20019Value1Destination) *NullableInlineResponse20019Value1Destination {
	return &NullableInlineResponse20019Value1Destination{value: val, isSet: true}
}

func (v NullableInlineResponse20019Value1Destination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20019Value1Destination) UnmarshalJSON(src []byte) error {
	v.isSet = true
