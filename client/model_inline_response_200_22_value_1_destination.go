...
// InlineResponse20022Value1Destination Destination of 'custom' type traffic filter
type InlineResponse20022Value1Destination struct {
...
func NewInlineResponse20022Value1Destination() *InlineResponse20022Value1Destination {
	this := InlineResponse20022Value1Destination{}
	return &this
}
...
func (o InlineResponse20022Value1Destination) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20022Value1Destination struct {
	value *InlineResponse20022Value1Destination
	isSet bool
}

func (v NullableInlineResponse20022Value1Destination) Get() *InlineResponse20022Value1Destination {
	return v.value
}

func (v *NullableInlineResponse20022Value1Destination) Set(val *InlineResponse20022Value1Destination) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20022Value1Destination) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20022Value1Destination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20022Value1Destination(val *InlineResponse20022Value1Destination) *NullableInlineResponse20022Value1Destination {
	return &NullableInlineResponse20022Value1Destination{value: val, isSet: true}
}

func (v NullableInlineResponse20022Value1Destination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20022Value1Destination) UnmarshalJSON(src []byte) error {
	v.isSet = true
