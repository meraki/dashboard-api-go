...
func (r ApplicationCategoriesApiGetNetworkApplianceFirewallL7FirewallRulesApplicationCategoriesRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *ApplicationCategoriesApiService) GetNetworkApplianceFirewallL7FirewallRulesApplicationCategoriesExecute(r ApplicationCategoriesApiGetNetworkApplianceFirewallL7FirewallRulesApplicationCategoriesRequest) (map[string]interface{}, *http.Response, error) {
	var (
