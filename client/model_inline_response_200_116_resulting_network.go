...
// InlineResponse200116ResultingNetwork Network after the combination
type InlineResponse200116ResultingNetwork struct {
	// Network ID
...
func NewInlineResponse200116ResultingNetwork() *InlineResponse200116ResultingNetwork {
	this := InlineResponse200116ResultingNetwork{}
	return &this
}
...
func (o InlineResponse200116ResultingNetwork) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200116ResultingNetwork struct {
	value *InlineResponse200116ResultingNetwork
	isSet bool
}

func (v NullableInlineResponse200116ResultingNetwork) Get() *InlineResponse200116ResultingNetwork {
	return v.value
}

func (v *NullableInlineResponse200116ResultingNetwork) Set(val *InlineResponse200116ResultingNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200116ResultingNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200116ResultingNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200116ResultingNetwork(val *InlineResponse200116ResultingNetwork) *NullableInlineResponse200116ResultingNetwork {
	return &NullableInlineResponse200116ResultingNetwork{value: val, isSet: true}
}

func (v NullableInlineResponse200116ResultingNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200116ResultingNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
