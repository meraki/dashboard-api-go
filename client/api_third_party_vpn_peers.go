...
func (r ThirdPartyVPNPeersApiGetOrganizationApplianceVpnThirdPartyVPNPeersRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *ThirdPartyVPNPeersApiService) GetOrganizationApplianceVpnThirdPartyVPNPeersExecute(r ThirdPartyVPNPeersApiGetOrganizationApplianceVpnThirdPartyVPNPeersRequest) (map[string]interface{}, *http.Response, error) {
	var (
...
func (r ThirdPartyVPNPeersApiUpdateOrganizationApplianceVpnThirdPartyVPNPeersRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return map[string]interface{}
func (a *ThirdPartyVPNPeersApiService) UpdateOrganizationApplianceVpnThirdPartyVPNPeersExecute(r ThirdPartyVPNPeersApiUpdateOrganizationApplianceVpnThirdPartyVPNPeersRequest) (map[string]interface{}, *http.Response, error) {
	var (
