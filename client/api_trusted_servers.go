...
func (r TrustedServersApiCreateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerRequest) Execute() (*InlineResponse20064, *http.Response, error) {
...
func (a *TrustedServersApiService) CreateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerExecute(r TrustedServersApiCreateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerRequest) (*InlineResponse20064, *http.Response, error) {
	var (
...
func (r TrustedServersApiGetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersRequest) Execute() ([]InlineResponse20064, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20064
func (a *TrustedServersApiService) GetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersExecute(r TrustedServersApiGetNetworkSwitchDhcpServerPolicyArpInspectionTrustedServersRequest) ([]InlineResponse20064, *http.Response, error) {
	var (
...
func (r TrustedServersApiUpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerRequest) Execute() (*InlineResponse20064, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20064
func (a *TrustedServersApiService) UpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerExecute(r TrustedServersApiUpdateNetworkSwitchDhcpServerPolicyArpInspectionTrustedServerRequest) (*InlineResponse20064, *http.Response, error) {
	var (
