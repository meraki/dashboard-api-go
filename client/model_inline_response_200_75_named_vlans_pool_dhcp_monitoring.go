...
// InlineResponse20075NamedVlansPoolDhcpMonitoring Named VLAN Pool DHCP Monitoring settings.
type InlineResponse20075NamedVlansPoolDhcpMonitoring struct {
...
func NewInlineResponse20075NamedVlansPoolDhcpMonitoring() *InlineResponse20075NamedVlansPoolDhcpMonitoring {
	this := InlineResponse20075NamedVlansPoolDhcpMonitoring{}
	return &this
}
...
func (o InlineResponse20075NamedVlansPoolDhcpMonitoring) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20075NamedVlansPoolDhcpMonitoring struct {
	value *InlineResponse20075NamedVlansPoolDhcpMonitoring
	isSet bool
}

func (v NullableInlineResponse20075NamedVlansPoolDhcpMonitoring) Get() *InlineResponse20075NamedVlansPoolDhcpMonitoring {
	return v.value
}

func (v *NullableInlineResponse20075NamedVlansPoolDhcpMonitoring) Set(val *InlineResponse20075NamedVlansPoolDhcpMonitoring) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20075NamedVlansPoolDhcpMonitoring) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20075NamedVlansPoolDhcpMonitoring) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20075NamedVlansPoolDhcpMonitoring(val *InlineResponse20075NamedVlansPoolDhcpMonitoring) *NullableInlineResponse20075NamedVlansPoolDhcpMonitoring {
	return &NullableInlineResponse20075NamedVlansPoolDhcpMonitoring{value: val, isSet: true}
}

func (v NullableInlineResponse20075NamedVlansPoolDhcpMonitoring) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20075NamedVlansPoolDhcpMonitoring) UnmarshalJSON(src []byte) error {
	v.isSet = true
