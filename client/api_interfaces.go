...
func (r InterfacesApiCreateDeviceSwitchRoutingInterfaceRequest) Execute() (*InlineResponse2006, *http.Response, error) {
...
func (a *InterfacesApiService) CreateDeviceSwitchRoutingInterfaceExecute(r InterfacesApiCreateDeviceSwitchRoutingInterfaceRequest) (*InlineResponse2006, *http.Response, error) {
	var (
...
func (r InterfacesApiCreateNetworkSwitchStackRoutingInterfaceRequest) CreateNetworkSwitchStackRoutingInterface(createNetworkSwitchStackRoutingInterface InlineObject132) InterfacesApiCreateNetworkSwitchStackRoutingInterfaceRequest {
...
func (r InterfacesApiGetDeviceSwitchRoutingInterfaceRequest) Execute() (*InlineResponse2006, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse2006
func (a *InterfacesApiService) GetDeviceSwitchRoutingInterfaceExecute(r InterfacesApiGetDeviceSwitchRoutingInterfaceRequest) (*InlineResponse2006, *http.Response, error) {
	var (
...
func (r InterfacesApiGetDeviceSwitchRoutingInterfacesRequest) Execute() ([]InlineResponse2006, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse2006
func (a *InterfacesApiService) GetDeviceSwitchRoutingInterfacesExecute(r InterfacesApiGetDeviceSwitchRoutingInterfacesRequest) ([]InlineResponse2006, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r InterfacesApiUpdateDeviceSwitchRoutingInterfaceRequest) Execute() (*InlineResponse2006, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse2006
func (a *InterfacesApiService) UpdateDeviceSwitchRoutingInterfaceExecute(r InterfacesApiUpdateDeviceSwitchRoutingInterfaceRequest) (*InlineResponse2006, *http.Response, error) {
	var (
...
func (r InterfacesApiUpdateNetworkSwitchStackRoutingInterfaceRequest) UpdateNetworkSwitchStackRoutingInterface(updateNetworkSwitchStackRoutingInterface InlineObject133) InterfacesApiUpdateNetworkSwitchStackRoutingInterfaceRequest {
...
func (r InterfacesApiUpdateNetworkSwitchStackRoutingInterfaceDhcpRequest) UpdateNetworkSwitchStackRoutingInterfaceDhcp(updateNetworkSwitchStackRoutingInterfaceDhcp InlineObject134) InterfacesApiUpdateNetworkSwitchStackRoutingInterfaceDhcpRequest {
