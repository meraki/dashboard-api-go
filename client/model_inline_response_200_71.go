...
type InlineResponse20071 struct {
	Alerts *InlineResponse20071Alerts `json:"alerts,omitempty"`
...
func (o *InlineResponse20071) GetAlerts() InlineResponse20071Alerts {
	if o == nil || isNil(o.Alerts) {
		var ret InlineResponse20071Alerts
		return ret
	}
	return *o.Alerts
}
...
// SetAlerts gets a reference to the given InlineResponse20071Alerts and assigns it to the Alerts field.
