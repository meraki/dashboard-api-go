...
func (r SyslogServersApiGetNetworkSyslogServersRequest) Execute() (*InlineResponse20069, *http.Response, error) {
...
func (a *SyslogServersApiService) GetNetworkSyslogServersExecute(r SyslogServersApiGetNetworkSyslogServersRequest) (*InlineResponse20069, *http.Response, error) {
	var (
...
func (r SyslogServersApiUpdateNetworkSyslogServersRequest) Execute() (*InlineResponse20069, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse20069
func (a *SyslogServersApiService) UpdateNetworkSyslogServersExecute(r SyslogServersApiUpdateNetworkSyslogServersRequest) (*InlineResponse20069, *http.Response, error) {
	var (
