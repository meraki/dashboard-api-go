...
// InlineResponse20034Counts Counts of currently alerting sensors, aggregated by alerting metric
type InlineResponse20034Counts struct {
	...
	Noise *InlineResponse20034CountsNoise `json:"noise,omitempty"`
...
func NewInlineResponse20034Counts() *InlineResponse20034Counts {
	this := InlineResponse20034Counts{}
	return &this
}
...
func (o *InlineResponse20034Counts) GetNoise() InlineResponse20034CountsNoise {
	if o == nil || isNil(o.Noise) {
		var ret InlineResponse20034CountsNoise
		return ret
	}
	return *o.Noise
}
...
// SetNoise gets a reference to the given InlineResponse20034CountsNoise and assigns it to the Noise field.
...
func (o InlineResponse20034Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20034Counts struct {
	value *InlineResponse20034Counts
	isSet bool
}

func (v NullableInlineResponse20034Counts) Get() *InlineResponse20034Counts {
	return v.value
}

func (v *NullableInlineResponse20034Counts) Set(val *InlineResponse20034Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20034Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20034Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20034Counts(val *InlineResponse20034Counts) *NullableInlineResponse20034Counts {
	return &NullableInlineResponse20034Counts{value: val, isSet: true}
}

func (v NullableInlineResponse20034Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20034Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
