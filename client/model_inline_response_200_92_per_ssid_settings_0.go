...
// InlineResponse20092PerSsidSettings0 Settings for SSID 0
type InlineResponse20092PerSsidSettings0 struct {
	// Name of SSID
...
func NewInlineResponse20092PerSsidSettings0() *InlineResponse20092PerSsidSettings0 {
	this := InlineResponse20092PerSsidSettings0{}
	return &this
}
...
func (o InlineResponse20092PerSsidSettings0) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20092PerSsidSettings0 struct {
	value *InlineResponse20092PerSsidSettings0
	isSet bool
}

func (v NullableInlineResponse20092PerSsidSettings0) Get() *InlineResponse20092PerSsidSettings0 {
	return v.value
}

func (v *NullableInlineResponse20092PerSsidSettings0) Set(val *InlineResponse20092PerSsidSettings0) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20092PerSsidSettings0) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20092PerSsidSettings0) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20092PerSsidSettings0(val *InlineResponse20092PerSsidSettings0) *NullableInlineResponse20092PerSsidSettings0 {
	return &NullableInlineResponse20092PerSsidSettings0{value: val, isSet: true}
}

func (v NullableInlineResponse20092PerSsidSettings0) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20092PerSsidSettings0) UnmarshalJSON(src []byte) error {
	v.isSet = true
