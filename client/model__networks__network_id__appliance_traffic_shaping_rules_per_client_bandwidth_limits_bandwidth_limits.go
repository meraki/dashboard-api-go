...
// NetworksNetworkIdApplianceTrafficShapingRulesPerClientBandwidthLimitsBandwidthLimits The bandwidth limits object, specifying the upload ('limitUp') and download ('limitDown') speed in Kbps. These are only enforced if 'settings' is set to 'custom'.
type NetworksNetworkIdApplianceTrafficShapingRulesPerClientBandwidthLimitsBandwidthLimits struct {
...
func NewNetworksNetworkIdApplianceTrafficShapingRulesPerClientBandwidthLimitsBandwidthLimits() *NetworksNetworkIdApplianceTrafficShapingRulesPerClientBandwidthLimitsBandwidthLimits {
	this := NetworksNetworkIdApplianceTrafficShapingRulesPerClientBandwidthLimitsBandwidthLimits{}
	return &this
}
...
func (o NetworksNetworkIdApplianceTrafficShapingRulesPerClientBandwidthLimitsBandwidthLimits) MarshalJSON() ([]byte, error) {
...
type NullableNetworksNetworkIdApplianceTrafficShapingRulesPerClientBandwidthLimitsBandwidthLimits struct {
	value *NetworksNetworkIdApplianceTrafficShapingRulesPerClientBandwidthLimitsBandwidthLimits
	isSet bool
}

func (v NullableNetworksNetworkIdApplianceTrafficShapingRulesPerClientBandwidthLimitsBandwidthLimits) Get() *NetworksNetworkIdApplianceTrafficShapingRulesPerClientBandwidthLimitsBandwidthLimits {
	return v.value
}

func (v *NullableNetworksNetworkIdApplianceTrafficShapingRulesPerClientBandwidthLimitsBandwidthLimits) Set(val *NetworksNetworkIdApplianceTrafficShapingRulesPerClientBandwidthLimitsBandwidthLimits) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworksNetworkIdApplianceTrafficShapingRulesPerClientBandwidthLimitsBandwidthLimits) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworksNetworkIdApplianceTrafficShapingRulesPerClientBandwidthLimitsBandwidthLimits) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworksNetworkIdApplianceTrafficShapingRulesPerClientBandwidthLimitsBandwidthLimits(val *NetworksNetworkIdApplianceTrafficShapingRulesPerClientBandwidthLimitsBandwidthLimits) *NullableNetworksNetworkIdApplianceTrafficShapingRulesPerClientBandwidthLimitsBandwidthLimits {
	return &NullableNetworksNetworkIdApplianceTrafficShapingRulesPerClientBandwidthLimitsBandwidthLimits{value: val, isSet: true}
}

func (v NullableNetworksNetworkIdApplianceTrafficShapingRulesPerClientBandwidthLimitsBandwidthLimits) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworksNetworkIdApplianceTrafficShapingRulesPerClientBandwidthLimitsBandwidthLimits) UnmarshalJSON(src []byte) error {
	v.isSet = true
