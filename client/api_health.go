...
func (r HealthApiGetNetworkHealthAlertsRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *HealthApiService) GetNetworkHealthAlertsExecute(r HealthApiGetNetworkHealthAlertsRequest) (map[string]interface{}, *http.Response, error) {
	var (
