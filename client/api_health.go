...
func (r HealthApiGetNetworkHealthAlertsRequest) Execute() ([]InlineResponse20030, *http.Response, error) {
...
func (a *HealthApiService) GetNetworkHealthAlertsExecute(r HealthApiGetNetworkHealthAlertsRequest) ([]InlineResponse20030, *http.Response, error) {
	var (
