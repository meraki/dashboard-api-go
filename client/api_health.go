...
func (r HealthApiGetNetworkHealthAlertsRequest) Execute() ([]InlineResponse20032, *http.Response, error) {
...
func (a *HealthApiService) GetNetworkHealthAlertsExecute(r HealthApiGetNetworkHealthAlertsRequest) ([]InlineResponse20032, *http.Response, error) {
	var (
