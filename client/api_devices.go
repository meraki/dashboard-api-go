...
func (a *DevicesApiService) GetNetworkSmDevicesExecute(r DevicesApiGetNetworkSmDevicesRequest) ([]GetNetworkSmDevices200ResponseInner, *http.Response, error) {
	...
	if r.uuids != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "uuids", s.Index(i), "multi")
			}
		} else {
	...
	if r.systemTypes != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "systemTypes", s.Index(i), "multi")
			}
		} else {
...
func (r DevicesApiInstallNetworkSmDeviceAppsRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *DevicesApiService) InstallNetworkSmDeviceAppsExecute(r DevicesApiInstallNetworkSmDeviceAppsRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	if r.installNetworkSmDeviceAppsRequest == nil {
		return nil, reportError("installNetworkSmDeviceAppsRequest is required and must be specified")
	}
...
func (r DevicesApiUninstallNetworkSmDeviceAppsRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *DevicesApiService) UninstallNetworkSmDeviceAppsExecute(r DevicesApiUninstallNetworkSmDeviceAppsRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	if r.uninstallNetworkSmDeviceAppsRequest == nil {
		return nil, reportError("uninstallNetworkSmDeviceAppsRequest is required and must be specified")
	}
