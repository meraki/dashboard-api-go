...
type InlineResponse20087 struct {
	...
	SplashLogo *InlineResponse20087SplashLogo `json:"splashLogo,omitempty"`
	SplashImage *InlineResponse20087SplashImage `json:"splashImage,omitempty"`
	SplashPrepaidFront *InlineResponse20087SplashPrepaidFront `json:"splashPrepaidFront,omitempty"`
	GuestSponsorship *InlineResponse20087GuestSponsorship `json:"guestSponsorship,omitempty"`
	...
	Billing *InlineResponse20087Billing `json:"billing,omitempty"`
	SentryEnrollment *InlineResponse20087SentryEnrollment `json:"sentryEnrollment,omitempty"`
	SelfRegistration *InlineResponse20087SelfRegistration `json:"selfRegistration,omitempty"`
}
...
func (o *InlineResponse20087) GetSplashLogo() InlineResponse20087SplashLogo {
	if o == nil || isNil(o.SplashLogo) {
		var ret InlineResponse20087SplashLogo
		return ret
	}
	return *o.SplashLogo
}
...
// SetSplashLogo gets a reference to the given InlineResponse20087SplashLogo and assigns it to the SplashLogo field.
...
func (o *InlineResponse20087) GetSplashImage() InlineResponse20087SplashImage {
	if o == nil || isNil(o.SplashImage) {
		var ret InlineResponse20087SplashImage
		return ret
	}
...
// SetSplashImage gets a reference to the given InlineResponse20087SplashImage and assigns it to the SplashImage field.
...
func (o *InlineResponse20087) GetSplashPrepaidFront() InlineResponse20087SplashPrepaidFront {
	if o == nil || isNil(o.SplashPrepaidFront) {
		var ret InlineResponse20087SplashPrepaidFront
		return ret
	}
...
// SetSplashPrepaidFront gets a reference to the given InlineResponse20087SplashPrepaidFront and assigns it to the SplashPrepaidFront field.
...
func (o *InlineResponse20087) GetGuestSponsorship() InlineResponse20087GuestSponsorship {
	if o == nil || isNil(o.GuestSponsorship) {
		var ret InlineResponse20087GuestSponsorship
		return ret
	}
...
// SetGuestSponsorship gets a reference to the given InlineResponse20087GuestSponsorship and assigns it to the GuestSponsorship field.
...
func (o *InlineResponse20087) GetBilling() InlineResponse20087Billing {
	if o == nil || isNil(o.Billing) {
		var ret InlineResponse20087Billing
		return ret
	}
	return *o.Billing
}
...
// SetBilling gets a reference to the given InlineResponse20087Billing and assigns it to the Billing field.
...
func (o *InlineResponse20087) GetSentryEnrollment() InlineResponse20087SentryEnrollment {
	if o == nil || isNil(o.SentryEnrollment) {
		var ret InlineResponse20087SentryEnrollment
		return ret
	}
...
// SetSentryEnrollment gets a reference to the given InlineResponse20087SentryEnrollment and assigns it to the SentryEnrollment field.
...
func (o *InlineResponse20087) GetSelfRegistration() InlineResponse20087SelfRegistration {
	if o == nil || isNil(o.SelfRegistration) {
		var ret InlineResponse20087SelfRegistration
		return ret
	}
...
// SetSelfRegistration gets a reference to the given InlineResponse20087SelfRegistration and assigns it to the SelfRegistration field.
