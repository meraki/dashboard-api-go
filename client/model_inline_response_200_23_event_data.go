...
// InlineResponse20023EventData An object containing more data related to the event.
type InlineResponse20023EventData struct {
...
func NewInlineResponse20023EventData() *InlineResponse20023EventData {
	this := InlineResponse20023EventData{}
	return &this
}
...
func (o *InlineResponse20023EventData) SetRadio(v string) {
	o.Radio = &v
}
...
func (o InlineResponse20023EventData) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20023EventData struct {
	value *InlineResponse20023EventData
	isSet bool
}

func (v NullableInlineResponse20023EventData) Get() *InlineResponse20023EventData {
	return v.value
}

func (v *NullableInlineResponse20023EventData) Set(val *InlineResponse20023EventData) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20023EventData) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20023EventData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20023EventData(val *InlineResponse20023EventData) *NullableInlineResponse20023EventData {
	return &NullableInlineResponse20023EventData{value: val, isSet: true}
}

func (v NullableInlineResponse20023EventData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20023EventData) UnmarshalJSON(src []byte) error {
	v.isSet = true
