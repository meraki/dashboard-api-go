...
// InlineResponse20069Servers struct for InlineResponse20069Servers
type InlineResponse20069Servers struct {
...
func NewInlineResponse20069Servers() *InlineResponse20069Servers {
	this := InlineResponse20069Servers{}
	return &this
}
...
func (o InlineResponse20069Servers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20069Servers struct {
	value *InlineResponse20069Servers
	isSet bool
}

func (v NullableInlineResponse20069Servers) Get() *InlineResponse20069Servers {
	return v.value
}

func (v *NullableInlineResponse20069Servers) Set(val *InlineResponse20069Servers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20069Servers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20069Servers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20069Servers(val *InlineResponse20069Servers) *NullableInlineResponse20069Servers {
	return &NullableInlineResponse20069Servers{value: val, isSet: true}
}

func (v NullableInlineResponse20069Servers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20069Servers) UnmarshalJSON(src []byte) error {
	v.isSet = true
