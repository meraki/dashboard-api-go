...
type InlineResponse20099 struct {
	...
	Components *InlineResponse20099Components `json:"components,omitempty"`
	// Model
...
func (o *InlineResponse20099) GetComponents() InlineResponse20099Components {
	if o == nil || isNil(o.Components) {
		var ret InlineResponse20099Components
		return ret
	}
	return *o.Components
}
...
// SetComponents gets a reference to the given InlineResponse20099Components and assigns it to the Components field.
