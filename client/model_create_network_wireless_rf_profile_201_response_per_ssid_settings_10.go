...
// CreateNetworkWirelessRfProfile201ResponsePerSsidSettings10 Settings for SSID 10
type CreateNetworkWirelessRfProfile201ResponsePerSsidSettings10 struct {
	// Name of SSID
...
func NewCreateNetworkWirelessRfProfile201ResponsePerSsidSettings10() *CreateNetworkWirelessRfProfile201ResponsePerSsidSettings10 {
	this := CreateNetworkWirelessRfProfile201ResponsePerSsidSettings10{}
	return &this
}
...
func (o CreateNetworkWirelessRfProfile201ResponsePerSsidSettings10) MarshalJSON() ([]byte, error) {
...
type NullableCreateNetworkWirelessRfProfile201ResponsePerSsidSettings10 struct {
	value *CreateNetworkWirelessRfProfile201ResponsePerSsidSettings10
	isSet bool
}

func (v NullableCreateNetworkWirelessRfProfile201ResponsePerSsidSettings10) Get() *CreateNetworkWirelessRfProfile201ResponsePerSsidSettings10 {
	return v.value
}

func (v *NullableCreateNetworkWirelessRfProfile201ResponsePerSsidSettings10) Set(val *CreateNetworkWirelessRfProfile201ResponsePerSsidSettings10) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateNetworkWirelessRfProfile201ResponsePerSsidSettings10) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateNetworkWirelessRfProfile201ResponsePerSsidSettings10) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateNetworkWirelessRfProfile201ResponsePerSsidSettings10(val *CreateNetworkWirelessRfProfile201ResponsePerSsidSettings10) *NullableCreateNetworkWirelessRfProfile201ResponsePerSsidSettings10 {
	return &NullableCreateNetworkWirelessRfProfile201ResponsePerSsidSettings10{value: val, isSet: true}
}

func (v NullableCreateNetworkWirelessRfProfile201ResponsePerSsidSettings10) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateNetworkWirelessRfProfile201ResponsePerSsidSettings10) UnmarshalJSON(src []byte) error {
	v.isSet = true
