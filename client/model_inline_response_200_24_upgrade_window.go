...
// InlineResponse20024UpgradeWindow Upgrade window for devices in network
type InlineResponse20024UpgradeWindow struct {
	// Day of the week
...
func NewInlineResponse20024UpgradeWindow() *InlineResponse20024UpgradeWindow {
	this := InlineResponse20024UpgradeWindow{}
	return &this
}
...
func (o InlineResponse20024UpgradeWindow) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20024UpgradeWindow struct {
	value *InlineResponse20024UpgradeWindow
	isSet bool
}

func (v NullableInlineResponse20024UpgradeWindow) Get() *InlineResponse20024UpgradeWindow {
	return v.value
}

func (v *NullableInlineResponse20024UpgradeWindow) Set(val *InlineResponse20024UpgradeWindow) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20024UpgradeWindow) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20024UpgradeWindow) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20024UpgradeWindow(val *InlineResponse20024UpgradeWindow) *NullableInlineResponse20024UpgradeWindow {
	return &NullableInlineResponse20024UpgradeWindow{value: val, isSet: true}
}

func (v NullableInlineResponse20024UpgradeWindow) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20024UpgradeWindow) UnmarshalJSON(src []byte) error {
	v.isSet = true
