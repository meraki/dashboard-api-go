...
// InlineResponse2001TwoFourGhzSettings Manual radio settings for 2.4 GHz
type InlineResponse2001TwoFourGhzSettings struct {
...
func NewInlineResponse2001TwoFourGhzSettings() *InlineResponse2001TwoFourGhzSettings {
	this := InlineResponse2001TwoFourGhzSettings{}
	return &this
}
...
func (o InlineResponse2001TwoFourGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse2001TwoFourGhzSettings struct {
	value *InlineResponse2001TwoFourGhzSettings
	isSet bool
}

func (v NullableInlineResponse2001TwoFourGhzSettings) Get() *InlineResponse2001TwoFourGhzSettings {
	return v.value
}

func (v *NullableInlineResponse2001TwoFourGhzSettings) Set(val *InlineResponse2001TwoFourGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse2001TwoFourGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse2001TwoFourGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse2001TwoFourGhzSettings(val *InlineResponse2001TwoFourGhzSettings) *NullableInlineResponse2001TwoFourGhzSettings {
	return &NullableInlineResponse2001TwoFourGhzSettings{value: val, isSet: true}
}

func (v NullableInlineResponse2001TwoFourGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse2001TwoFourGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
