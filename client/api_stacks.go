...
func (r StacksApiGetNetworkSwitchStackRequest) Execute() (*InlineResponse20067, *http.Response, error) {
...
func (a *StacksApiService) GetNetworkSwitchStackExecute(r StacksApiGetNetworkSwitchStackRequest) (*InlineResponse20067, *http.Response, error) {
	var (
