...
func (r StacksApiAddNetworkSwitchStackRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *StacksApiService) AddNetworkSwitchStackExecute(r StacksApiAddNetworkSwitchStackRequest) (map[string]interface{}, *http.Response, error) {
	var (
...
func (r StacksApiGetNetworkSwitchStackRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return map[string]interface{}
func (a *StacksApiService) GetNetworkSwitchStackExecute(r StacksApiGetNetworkSwitchStackRequest) (map[string]interface{}, *http.Response, error) {
	var (
