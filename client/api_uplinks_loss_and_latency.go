...
func (r UplinksLossAndLatencyApiGetOrganizationDevicesUplinksLossAndLatencyRequest) Execute() ([]InlineResponse200122, *http.Response, error) {
...
func (a *UplinksLossAndLatencyApiService) GetOrganizationDevicesUplinksLossAndLatencyExecute(r UplinksLossAndLatencyApiGetOrganizationDevicesUplinksLossAndLatencyRequest) ([]InlineResponse200122, *http.Response, error) {
	var (
