...
type UplinksLossAndLatencyApiGetOrganizationUplinksLossAndLatencyRequest struct {
	ctx context.Context
	ApiService *UplinksLossAndLatencyApiService
	organizationId string
	t0 *string
...
// The beginning of the timespan for the data. The maximum lookback period is 60 days from today.
func (r UplinksLossAndLatencyApiGetOrganizationUplinksLossAndLatencyRequest) T0(t0 string) UplinksLossAndLatencyApiGetOrganizationUplinksLossAndLatencyRequest {
	r.t0 = &t0
	return r
}

// The end of the timespan for the data. t1 can be a maximum of 5 minutes after t0. The latest possible time that t1 can be is 2 minutes into the past.
func (r UplinksLossAndLatencyApiGetOrganizationUplinksLossAndLatencyRequest) T1(t1 string) UplinksLossAndLatencyApiGetOrganizationUplinksLossAndLatencyRequest {
	r.t1 = &t1
	return r
}

// The timespan for which the information will be fetched. If specifying timespan, do not specify parameters t0 and t1. The value must be in seconds and be less than or equal to 5 minutes. The default is 5 minutes.
func (r UplinksLossAndLatencyApiGetOrganizationUplinksLossAndLatencyRequest) Timespan(timespan float32) UplinksLossAndLatencyApiGetOrganizationUplinksLossAndLatencyRequest {
	r.timespan = &timespan
	return r
}

// Optional filter for a specific WAN uplink. Valid uplinks are wan1, wan2, wan3, cellular. Default will return all uplinks.
func (r UplinksLossAndLatencyApiGetOrganizationUplinksLossAndLatencyRequest) Uplink(uplink string) UplinksLossAndLatencyApiGetOrganizationUplinksLossAndLatencyRequest {
	r.uplink = &uplink
	return r
}

// Optional filter for a specific destination IP. Default will return all destination IPs.
func (r UplinksLossAndLatencyApiGetOrganizationUplinksLossAndLatencyRequest) Ip(ip string) UplinksLossAndLatencyApiGetOrganizationUplinksLossAndLatencyRequest {
	r.ip = &ip
	return r
}

func (r UplinksLossAndLatencyApiGetOrganizationUplinksLossAndLatencyRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
...
Return the uplink loss and latency for every MX in the organization from at latest 2 minutes ago
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param organizationId Organization ID
 @return UplinksLossAndLatencyApiGetOrganizationUplinksLossAndLatencyRequest
*/
func (a *UplinksLossAndLatencyApiService) GetOrganizationUplinksLossAndLatency(ctx context.Context, organizationId string) UplinksLossAndLatencyApiGetOrganizationUplinksLossAndLatencyRequest {
	return UplinksLossAndLatencyApiGetOrganizationUplinksLossAndLatencyRequest{
		ApiService: a,
		ctx: ctx,
		organizationId: organizationId,
...
func (a *UplinksLossAndLatencyApiService) GetOrganizationUplinksLossAndLatencyExecute(r UplinksLossAndLatencyApiGetOrganizationUplinksLossAndLatencyRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UplinksLossAndLatencyApiService.GetOrganizationUplinksLossAndLatency")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
