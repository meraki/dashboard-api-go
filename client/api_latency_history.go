...
func (r LatencyHistoryApiGetNetworkWirelessLatencyHistoryRequest) Execute() ([]InlineResponse20074, *http.Response, error) {
...
func (a *LatencyHistoryApiService) GetNetworkWirelessLatencyHistoryExecute(r LatencyHistoryApiGetNetworkWirelessLatencyHistoryRequest) ([]InlineResponse20074, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
