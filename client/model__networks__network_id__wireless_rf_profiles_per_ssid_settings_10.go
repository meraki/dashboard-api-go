...
// NetworksNetworkIdWirelessRfProfilesPerSsidSettings10 Settings for SSID 10
type NetworksNetworkIdWirelessRfProfilesPerSsidSettings10 struct {
...
func NewNetworksNetworkIdWirelessRfProfilesPerSsidSettings10() *NetworksNetworkIdWirelessRfProfilesPerSsidSettings10 {
	this := NetworksNetworkIdWirelessRfProfilesPerSsidSettings10{}
	return &this
}
...
func (o NetworksNetworkIdWirelessRfProfilesPerSsidSettings10) MarshalJSON() ([]byte, error) {
...
type NullableNetworksNetworkIdWirelessRfProfilesPerSsidSettings10 struct {
	value *NetworksNetworkIdWirelessRfProfilesPerSsidSettings10
	isSet bool
}

func (v NullableNetworksNetworkIdWirelessRfProfilesPerSsidSettings10) Get() *NetworksNetworkIdWirelessRfProfilesPerSsidSettings10 {
	return v.value
}

func (v *NullableNetworksNetworkIdWirelessRfProfilesPerSsidSettings10) Set(val *NetworksNetworkIdWirelessRfProfilesPerSsidSettings10) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworksNetworkIdWirelessRfProfilesPerSsidSettings10) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworksNetworkIdWirelessRfProfilesPerSsidSettings10) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworksNetworkIdWirelessRfProfilesPerSsidSettings10(val *NetworksNetworkIdWirelessRfProfilesPerSsidSettings10) *NullableNetworksNetworkIdWirelessRfProfilesPerSsidSettings10 {
	return &NullableNetworksNetworkIdWirelessRfProfilesPerSsidSettings10{value: val, isSet: true}
}

func (v NullableNetworksNetworkIdWirelessRfProfilesPerSsidSettings10) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworksNetworkIdWirelessRfProfilesPerSsidSettings10) UnmarshalJSON(src []byte) error {
	v.isSet = true
