...
// InlineResponse2014PerSsidSettings10 Settings for SSID 10
type InlineResponse2014PerSsidSettings10 struct {
	// Name of SSID
...
func NewInlineResponse2014PerSsidSettings10() *InlineResponse2014PerSsidSettings10 {
	this := InlineResponse2014PerSsidSettings10{}
	return &this
}
...
func (o InlineResponse2014PerSsidSettings10) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse2014PerSsidSettings10 struct {
	value *InlineResponse2014PerSsidSettings10
	isSet bool
}

func (v NullableInlineResponse2014PerSsidSettings10) Get() *InlineResponse2014PerSsidSettings10 {
	return v.value
}

func (v *NullableInlineResponse2014PerSsidSettings10) Set(val *InlineResponse2014PerSsidSettings10) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse2014PerSsidSettings10) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse2014PerSsidSettings10) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse2014PerSsidSettings10(val *InlineResponse2014PerSsidSettings10) *NullableInlineResponse2014PerSsidSettings10 {
	return &NullableInlineResponse2014PerSsidSettings10{value: val, isSet: true}
}

func (v NullableInlineResponse2014PerSsidSettings10) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse2014PerSsidSettings10) UnmarshalJSON(src []byte) error {
	v.isSet = true
