...
func (r DataRateHistoryApiGetNetworkWirelessDataRateHistoryRequest) Execute() ([]InlineResponse20072, *http.Response, error) {
...
func (a *DataRateHistoryApiService) GetNetworkWirelessDataRateHistoryExecute(r DataRateHistoryApiGetNetworkWirelessDataRateHistoryRequest) ([]InlineResponse20072, *http.Response, error) {
	var (
