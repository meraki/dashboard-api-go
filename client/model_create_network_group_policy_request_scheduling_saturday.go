...
func NewCreateNetworkGroupPolicyRequestSchedulingSaturday() *CreateNetworkGroupPolicyRequestSchedulingSaturday {
	this := CreateNetworkGroupPolicyRequestSchedulingSaturday{}
	return &this
}
...
type NullableCreateNetworkGroupPolicyRequestSchedulingSaturday struct {
	value *CreateNetworkGroupPolicyRequestSchedulingSaturday
	isSet bool
}

func (v NullableCreateNetworkGroupPolicyRequestSchedulingSaturday) Get() *CreateNetworkGroupPolicyRequestSchedulingSaturday {
	return v.value
}

func (v *NullableCreateNetworkGroupPolicyRequestSchedulingSaturday) Set(val *CreateNetworkGroupPolicyRequestSchedulingSaturday) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateNetworkGroupPolicyRequestSchedulingSaturday) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateNetworkGroupPolicyRequestSchedulingSaturday) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateNetworkGroupPolicyRequestSchedulingSaturday(val *CreateNetworkGroupPolicyRequestSchedulingSaturday) *NullableCreateNetworkGroupPolicyRequestSchedulingSaturday {
	return &NullableCreateNetworkGroupPolicyRequestSchedulingSaturday{value: val, isSet: true}
}

func (v NullableCreateNetworkGroupPolicyRequestSchedulingSaturday) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateNetworkGroupPolicyRequestSchedulingSaturday) UnmarshalJSON(src []byte) error {
	v.isSet = true
