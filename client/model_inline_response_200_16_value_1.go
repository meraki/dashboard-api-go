...
// InlineResponse20016Value1 Value of traffic filter
type InlineResponse20016Value1 struct {
	...
	Source *InlineResponse20016Value1Source `json:"source,omitempty"`
	Destination *InlineResponse20016Value1Destination `json:"destination,omitempty"`
}
...
func NewInlineResponse20016Value1() *InlineResponse20016Value1 {
	this := InlineResponse20016Value1{}
	return &this
}
...
func (o *InlineResponse20016Value1) GetSource() InlineResponse20016Value1Source {
	if o == nil || isNil(o.Source) {
		var ret InlineResponse20016Value1Source
		return ret
	}
	return *o.Source
}
...
// SetSource gets a reference to the given InlineResponse20016Value1Source and assigns it to the Source field.
...
func (o *InlineResponse20016Value1) GetDestination() InlineResponse20016Value1Destination {
	if o == nil || isNil(o.Destination) {
		var ret InlineResponse20016Value1Destination
		return ret
	}
...
// SetDestination gets a reference to the given InlineResponse20016Value1Destination and assigns it to the Destination field.
func (o *InlineResponse20016Value1) SetDestination(v InlineResponse20016Value1Destination) {
	o.Destination = &v
}

func (o InlineResponse20016Value1) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20016Value1 struct {
	value *InlineResponse20016Value1
	isSet bool
}

func (v NullableInlineResponse20016Value1) Get() *InlineResponse20016Value1 {
	return v.value
}

func (v *NullableInlineResponse20016Value1) Set(val *InlineResponse20016Value1) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20016Value1) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20016Value1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20016Value1(val *InlineResponse20016Value1) *NullableInlineResponse20016Value1 {
	return &NullableInlineResponse20016Value1{value: val, isSet: true}
}

func (v NullableInlineResponse20016Value1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20016Value1) UnmarshalJSON(src []byte) error {
	v.isSet = true
