...
// checks if the CreateNetworkGroupPolicyRequestSchedulingWednesday type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateNetworkGroupPolicyRequestSchedulingWednesday{}

// CreateNetworkGroupPolicyRequestSchedulingWednesday The schedule object for Wednesday.
type CreateNetworkGroupPolicyRequestSchedulingWednesday struct {
...
func NewCreateNetworkGroupPolicyRequestSchedulingWednesday() *CreateNetworkGroupPolicyRequestSchedulingWednesday {
	this := CreateNetworkGroupPolicyRequestSchedulingWednesday{}
	return &this
}
...
func (o CreateNetworkGroupPolicyRequestSchedulingWednesday) MarshalJSON() ([]byte, error) {
...
func (o CreateNetworkGroupPolicyRequestSchedulingWednesday) ToMap() (map[string]interface{}, error) {
...
type NullableCreateNetworkGroupPolicyRequestSchedulingWednesday struct {
	value *CreateNetworkGroupPolicyRequestSchedulingWednesday
	isSet bool
}

func (v NullableCreateNetworkGroupPolicyRequestSchedulingWednesday) Get() *CreateNetworkGroupPolicyRequestSchedulingWednesday {
	return v.value
}

func (v *NullableCreateNetworkGroupPolicyRequestSchedulingWednesday) Set(val *CreateNetworkGroupPolicyRequestSchedulingWednesday) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateNetworkGroupPolicyRequestSchedulingWednesday) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateNetworkGroupPolicyRequestSchedulingWednesday) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateNetworkGroupPolicyRequestSchedulingWednesday(val *CreateNetworkGroupPolicyRequestSchedulingWednesday) *NullableCreateNetworkGroupPolicyRequestSchedulingWednesday {
	return &NullableCreateNetworkGroupPolicyRequestSchedulingWednesday{value: val, isSet: true}
}

func (v NullableCreateNetworkGroupPolicyRequestSchedulingWednesday) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateNetworkGroupPolicyRequestSchedulingWednesday) UnmarshalJSON(src []byte) error {
	v.isSet = true
