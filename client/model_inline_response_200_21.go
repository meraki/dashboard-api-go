...
type InlineResponse20021 struct {
	...
	ClientVpnConnections []InlineResponse20021ClientVpnConnections `json:"clientVpnConnections,omitempty"`
...
func (o *InlineResponse20021) GetClientVpnConnections() []InlineResponse20021ClientVpnConnections {
	if o == nil || isNil(o.ClientVpnConnections) {
		var ret []InlineResponse20021ClientVpnConnections
		return ret
	}
...
// SetClientVpnConnections gets a reference to the given []InlineResponse20021ClientVpnConnections and assigns it to the ClientVpnConnections field.
