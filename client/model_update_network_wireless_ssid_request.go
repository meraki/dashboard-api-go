...
type UpdateNetworkWirelessSsidRequest struct {
	...
	Dot11w *UpdateNetworkWirelessSsidRequestDot11w `json:"dot11w,omitempty"`
...
func (o *UpdateNetworkWirelessSsidRequest) GetDot11w() UpdateNetworkWirelessSsidRequestDot11w {
	if o == nil || isNil(o.Dot11w) {
		var ret UpdateNetworkWirelessSsidRequestDot11w
		return ret
	}
	return *o.Dot11w
}
...
// SetDot11w gets a reference to the given UpdateNetworkWirelessSsidRequestDot11w and assigns it to the Dot11w field.
