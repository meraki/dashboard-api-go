...
func (r MerakiAuthUsersApiCreateNetworkMerakiAuthUserRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *MerakiAuthUsersApiService) CreateNetworkMerakiAuthUserExecute(r MerakiAuthUsersApiCreateNetworkMerakiAuthUserRequest) (map[string]interface{}, *http.Response, error) {
	var (
...
func (r MerakiAuthUsersApiGetNetworkMerakiAuthUserRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return map[string]interface{}
func (a *MerakiAuthUsersApiService) GetNetworkMerakiAuthUserExecute(r MerakiAuthUsersApiGetNetworkMerakiAuthUserRequest) (map[string]interface{}, *http.Response, error) {
	var (
...
func (r MerakiAuthUsersApiGetNetworkMerakiAuthUsersRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return []map[string]interface{}
func (a *MerakiAuthUsersApiService) GetNetworkMerakiAuthUsersExecute(r MerakiAuthUsersApiGetNetworkMerakiAuthUsersRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r MerakiAuthUsersApiUpdateNetworkMerakiAuthUserRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return map[string]interface{}
func (a *MerakiAuthUsersApiService) UpdateNetworkMerakiAuthUserExecute(r MerakiAuthUsersApiUpdateNetworkMerakiAuthUserRequest) (map[string]interface{}, *http.Response, error) {
	var (
