...
// InlineResponse20067Rules struct for InlineResponse20067Rules
type InlineResponse20067Rules struct {
...
func (o InlineResponse20067Rules) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20067Rules struct {
	value *InlineResponse20067Rules
	isSet bool
}

func (v NullableInlineResponse20067Rules) Get() *InlineResponse20067Rules {
	return v.value
}

func (v *NullableInlineResponse20067Rules) Set(val *InlineResponse20067Rules) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20067Rules) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20067Rules) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20067Rules(val *InlineResponse20067Rules) *NullableInlineResponse20067Rules {
	return &NullableInlineResponse20067Rules{value: val, isSet: true}
}

func (v NullableInlineResponse20067Rules) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20067Rules) UnmarshalJSON(src []byte) error {
	v.isSet = true
