...
func (o *InlineObject30) GetAllowedUrlPatterns() []string {
...
func (o *InlineObject30) GetAllowedUrlPatternsOk() ([]string, bool) {
	if o == nil || isNil(o.AllowedUrlPatterns) {
    return nil, false
	}
...
func (o *InlineObject30) HasAllowedUrlPatterns() bool {
	if o != nil && !isNil(o.AllowedUrlPatterns) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *InlineObject30) GetBlockedUrlPatternsOk() ([]string, bool) {
	if o == nil || isNil(o.BlockedUrlPatterns) {
    return nil, false
	}
...
func (o *InlineObject30) HasBlockedUrlPatterns() bool {
	if o != nil && !isNil(o.BlockedUrlPatterns) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *InlineObject30) GetBlockedUrlCategoriesOk() ([]string, bool) {
	if o == nil || isNil(o.BlockedUrlCategories) {
    return nil, false
	}
...
func (o *InlineObject30) HasBlockedUrlCategories() bool {
	if o != nil && !isNil(o.BlockedUrlCategories) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *InlineObject30) GetUrlCategoryListSizeOk() (*string, bool) {
	if o == nil || isNil(o.UrlCategoryListSize) {
    return nil, false
	}
...
func (o *InlineObject30) HasUrlCategoryListSize() bool {
	if o != nil && !isNil(o.UrlCategoryListSize) {
		return true
	}
...
func (o *InlineObject30) SetUrlCategoryListSize(v string) {
