...
type UpdateNetworkSettingsRequest struct {
	...
	SecureConnect *UpdateNetworkSettingsRequestSecureConnect `json:"secureConnect,omitempty"`
...
func (o *UpdateNetworkSettingsRequest) GetSecureConnect() UpdateNetworkSettingsRequestSecureConnect {
	if o == nil || isNil(o.SecureConnect) {
		var ret UpdateNetworkSettingsRequestSecureConnect
		return ret
	}
...
// SetSecureConnect gets a reference to the given UpdateNetworkSettingsRequestSecureConnect and assigns it to the SecureConnect field.
