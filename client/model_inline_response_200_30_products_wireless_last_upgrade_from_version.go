...
// InlineResponse20030ProductsWirelessLastUpgradeFromVersion Details of the version the device upgraded from
type InlineResponse20030ProductsWirelessLastUpgradeFromVersion struct {
...
func NewInlineResponse20030ProductsWirelessLastUpgradeFromVersion() *InlineResponse20030ProductsWirelessLastUpgradeFromVersion {
	this := InlineResponse20030ProductsWirelessLastUpgradeFromVersion{}
	return &this
}
...
func (o InlineResponse20030ProductsWirelessLastUpgradeFromVersion) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20030ProductsWirelessLastUpgradeFromVersion struct {
	value *InlineResponse20030ProductsWirelessLastUpgradeFromVersion
	isSet bool
}

func (v NullableInlineResponse20030ProductsWirelessLastUpgradeFromVersion) Get() *InlineResponse20030ProductsWirelessLastUpgradeFromVersion {
	return v.value
}

func (v *NullableInlineResponse20030ProductsWirelessLastUpgradeFromVersion) Set(val *InlineResponse20030ProductsWirelessLastUpgradeFromVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20030ProductsWirelessLastUpgradeFromVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20030ProductsWirelessLastUpgradeFromVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20030ProductsWirelessLastUpgradeFromVersion(val *InlineResponse20030ProductsWirelessLastUpgradeFromVersion) *NullableInlineResponse20030ProductsWirelessLastUpgradeFromVersion {
	return &NullableInlineResponse20030ProductsWirelessLastUpgradeFromVersion{value: val, isSet: true}
}

func (v NullableInlineResponse20030ProductsWirelessLastUpgradeFromVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20030ProductsWirelessLastUpgradeFromVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
