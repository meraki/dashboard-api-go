...
func (r PortsApiGetDeviceSwitchPortsStatusesRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return []map[string]interface{}
func (a *PortsApiService) GetDeviceSwitchPortsStatusesExecute(r PortsApiGetDeviceSwitchPortsStatusesRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
