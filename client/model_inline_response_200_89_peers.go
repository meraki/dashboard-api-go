...
// InlineResponse20089Peers struct for InlineResponse20089Peers
type InlineResponse20089Peers struct {
	...
	IpsecPolicies *InlineResponse20089IpsecPolicies `json:"ipsecPolicies,omitempty"`
...
func (o *InlineResponse20089Peers) GetIpsecPolicies() InlineResponse20089IpsecPolicies {
	if o == nil || isNil(o.IpsecPolicies) {
		var ret InlineResponse20089IpsecPolicies
		return ret
	}
...
// SetIpsecPolicies gets a reference to the given InlineResponse20089IpsecPolicies and assigns it to the IpsecPolicies field.
...
func (o InlineResponse20089Peers) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20089Peers struct {
	value *InlineResponse20089Peers
	isSet bool
}

func (v NullableInlineResponse20089Peers) Get() *InlineResponse20089Peers {
	return v.value
}

func (v *NullableInlineResponse20089Peers) Set(val *InlineResponse20089Peers) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20089Peers) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20089Peers) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20089Peers(val *InlineResponse20089Peers) *NullableInlineResponse20089Peers {
	return &NullableInlineResponse20089Peers{value: val, isSet: true}
}

func (v NullableInlineResponse20089Peers) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20089Peers) UnmarshalJSON(src []byte) error {
	v.isSet = true
