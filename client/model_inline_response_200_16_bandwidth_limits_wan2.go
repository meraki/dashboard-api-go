...
// InlineResponse20016BandwidthLimitsWan2 uplink wan2 configued limits [optional]
type InlineResponse20016BandwidthLimitsWan2 struct {
...
func NewInlineResponse20016BandwidthLimitsWan2() *InlineResponse20016BandwidthLimitsWan2 {
	this := InlineResponse20016BandwidthLimitsWan2{}
	return &this
}
...
func (o InlineResponse20016BandwidthLimitsWan2) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20016BandwidthLimitsWan2 struct {
	value *InlineResponse20016BandwidthLimitsWan2
	isSet bool
}

func (v NullableInlineResponse20016BandwidthLimitsWan2) Get() *InlineResponse20016BandwidthLimitsWan2 {
	return v.value
}

func (v *NullableInlineResponse20016BandwidthLimitsWan2) Set(val *InlineResponse20016BandwidthLimitsWan2) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20016BandwidthLimitsWan2) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20016BandwidthLimitsWan2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20016BandwidthLimitsWan2(val *InlineResponse20016BandwidthLimitsWan2) *NullableInlineResponse20016BandwidthLimitsWan2 {
	return &NullableInlineResponse20016BandwidthLimitsWan2{value: val, isSet: true}
}

func (v NullableInlineResponse20016BandwidthLimitsWan2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20016BandwidthLimitsWan2) UnmarshalJSON(src []byte) error {
	v.isSet = true
