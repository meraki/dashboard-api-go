...
// InlineResponse20033CountsNoise Object containing the number of sensors that are currently alerting due to noise readings
type InlineResponse20033CountsNoise struct {
...
func NewInlineResponse20033CountsNoise() *InlineResponse20033CountsNoise {
	this := InlineResponse20033CountsNoise{}
	return &this
}
...
func (o InlineResponse20033CountsNoise) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20033CountsNoise struct {
	value *InlineResponse20033CountsNoise
	isSet bool
}

func (v NullableInlineResponse20033CountsNoise) Get() *InlineResponse20033CountsNoise {
	return v.value
}

func (v *NullableInlineResponse20033CountsNoise) Set(val *InlineResponse20033CountsNoise) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20033CountsNoise) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20033CountsNoise) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20033CountsNoise(val *InlineResponse20033CountsNoise) *NullableInlineResponse20033CountsNoise {
	return &NullableInlineResponse20033CountsNoise{value: val, isSet: true}
}

func (v NullableInlineResponse20033CountsNoise) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20033CountsNoise) UnmarshalJSON(src []byte) error {
	v.isSet = true
