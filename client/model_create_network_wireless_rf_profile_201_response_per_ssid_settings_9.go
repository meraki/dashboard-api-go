...
// CreateNetworkWirelessRfProfile201ResponsePerSsidSettings9 Settings for SSID 9
type CreateNetworkWirelessRfProfile201ResponsePerSsidSettings9 struct {
	// Name of SSID
...
func NewCreateNetworkWirelessRfProfile201ResponsePerSsidSettings9() *CreateNetworkWirelessRfProfile201ResponsePerSsidSettings9 {
	this := CreateNetworkWirelessRfProfile201ResponsePerSsidSettings9{}
	return &this
}
...
func (o CreateNetworkWirelessRfProfile201ResponsePerSsidSettings9) MarshalJSON() ([]byte, error) {
...
type NullableCreateNetworkWirelessRfProfile201ResponsePerSsidSettings9 struct {
	value *CreateNetworkWirelessRfProfile201ResponsePerSsidSettings9
	isSet bool
}

func (v NullableCreateNetworkWirelessRfProfile201ResponsePerSsidSettings9) Get() *CreateNetworkWirelessRfProfile201ResponsePerSsidSettings9 {
	return v.value
}

func (v *NullableCreateNetworkWirelessRfProfile201ResponsePerSsidSettings9) Set(val *CreateNetworkWirelessRfProfile201ResponsePerSsidSettings9) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateNetworkWirelessRfProfile201ResponsePerSsidSettings9) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateNetworkWirelessRfProfile201ResponsePerSsidSettings9) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateNetworkWirelessRfProfile201ResponsePerSsidSettings9(val *CreateNetworkWirelessRfProfile201ResponsePerSsidSettings9) *NullableCreateNetworkWirelessRfProfile201ResponsePerSsidSettings9 {
	return &NullableCreateNetworkWirelessRfProfile201ResponsePerSsidSettings9{value: val, isSet: true}
}

func (v NullableCreateNetworkWirelessRfProfile201ResponsePerSsidSettings9) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateNetworkWirelessRfProfile201ResponsePerSsidSettings9) UnmarshalJSON(src []byte) error {
	v.isSet = true
