...
type InlineResponse20063 struct {
	...
	PowerExceptions []InlineResponse20063PowerExceptions `json:"powerExceptions,omitempty"`
}
...
func (o *InlineResponse20063) GetPowerExceptions() []InlineResponse20063PowerExceptions {
	if o == nil || isNil(o.PowerExceptions) {
		var ret []InlineResponse20063PowerExceptions
		return ret
	}
...
// SetPowerExceptions gets a reference to the given []InlineResponse20063PowerExceptions and assigns it to the PowerExceptions field.
