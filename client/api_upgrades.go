...
func (r UpgradesApiGetOrganizationFirmwareUpgradesRequest) Execute() ([]InlineResponse200103, *http.Response, error) {
...
func (a *UpgradesApiService) GetOrganizationFirmwareUpgradesExecute(r UpgradesApiGetOrganizationFirmwareUpgradesRequest) ([]InlineResponse200103, *http.Response, error) {
	var (
...
func (r UpgradesApiGetOrganizationFirmwareUpgradesByDeviceRequest) Execute() ([]InlineResponse200104, *http.Response, error) {
...
func (a *UpgradesApiService) GetOrganizationFirmwareUpgradesByDeviceExecute(r UpgradesApiGetOrganizationFirmwareUpgradesByDeviceRequest) ([]InlineResponse200104, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
