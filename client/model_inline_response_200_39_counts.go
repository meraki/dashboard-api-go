...
// InlineResponse20039Counts Counts of currently alerting sensors, aggregated by alerting metric
type InlineResponse20039Counts struct {
	...
	Noise *InlineResponse20039CountsNoise `json:"noise,omitempty"`
...
func NewInlineResponse20039Counts() *InlineResponse20039Counts {
	this := InlineResponse20039Counts{}
	return &this
}
...
func (o *InlineResponse20039Counts) GetNoise() InlineResponse20039CountsNoise {
	if o == nil || isNil(o.Noise) {
		var ret InlineResponse20039CountsNoise
		return ret
	}
	return *o.Noise
}
...
// SetNoise gets a reference to the given InlineResponse20039CountsNoise and assigns it to the Noise field.
...
func (o InlineResponse20039Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20039Counts struct {
	value *InlineResponse20039Counts
	isSet bool
}

func (v NullableInlineResponse20039Counts) Get() *InlineResponse20039Counts {
	return v.value
}

func (v *NullableInlineResponse20039Counts) Set(val *InlineResponse20039Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20039Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20039Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20039Counts(val *InlineResponse20039Counts) *NullableInlineResponse20039Counts {
	return &NullableInlineResponse20039Counts{value: val, isSet: true}
}

func (v NullableInlineResponse20039Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20039Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
