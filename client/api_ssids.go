...
func (r SsidsApiGetNetworkWirelessSsidEapOverrideRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return map[string]interface{}
func (a *SsidsApiService) GetNetworkWirelessSsidEapOverrideExecute(r SsidsApiGetNetworkWirelessSsidEapOverrideRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
