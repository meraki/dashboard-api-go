...
func (r VpnApiGetOrganizationApplianceVpnVpnFirewallRulesRequest) Execute() (*GetOrganizationApplianceVpnVpnFirewallRules200Response, *http.Response, error) {
...
func (a *VpnApiService) GetOrganizationApplianceVpnVpnFirewallRulesExecute(r VpnApiGetOrganizationApplianceVpnVpnFirewallRulesRequest) (*GetOrganizationApplianceVpnVpnFirewallRules200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r VpnApiUpdateOrganizationApplianceVpnVpnFirewallRulesRequest) Execute() (*GetOrganizationApplianceVpnVpnFirewallRules200Response, *http.Response, error) {
...
// Execute executes the request
//  @return GetOrganizationApplianceVpnVpnFirewallRules200Response
func (a *VpnApiService) UpdateOrganizationApplianceVpnVpnFirewallRulesExecute(r VpnApiUpdateOrganizationApplianceVpnVpnFirewallRulesRequest) (*GetOrganizationApplianceVpnVpnFirewallRules200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
