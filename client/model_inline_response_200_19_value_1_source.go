...
// InlineResponse20019Value1Source Source of 'custom' type traffic filter
type InlineResponse20019Value1Source struct {
...
func NewInlineResponse20019Value1Source() *InlineResponse20019Value1Source {
	this := InlineResponse20019Value1Source{}
	return &this
}
...
func (o InlineResponse20019Value1Source) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20019Value1Source struct {
	value *InlineResponse20019Value1Source
	isSet bool
}

func (v NullableInlineResponse20019Value1Source) Get() *InlineResponse20019Value1Source {
	return v.value
}

func (v *NullableInlineResponse20019Value1Source) Set(val *InlineResponse20019Value1Source) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20019Value1Source) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20019Value1Source) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20019Value1Source(val *InlineResponse20019Value1Source) *NullableInlineResponse20019Value1Source {
	return &NullableInlineResponse20019Value1Source{value: val, isSet: true}
}

func (v NullableInlineResponse20019Value1Source) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20019Value1Source) UnmarshalJSON(src []byte) error {
	v.isSet = true
