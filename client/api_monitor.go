...
type MonitorApiGetOrganizationUplinksLossAndLatencyRequest struct {
	ctx context.Context
	ApiService *MonitorApiService
	organizationId string
	t0 *string
...
// The beginning of the timespan for the data. The maximum lookback period is 60 days from today.
func (r MonitorApiGetOrganizationUplinksLossAndLatencyRequest) T0(t0 string) MonitorApiGetOrganizationUplinksLossAndLatencyRequest {
	r.t0 = &t0
	return r
}

// The end of the timespan for the data. t1 can be a maximum of 5 minutes after t0. The latest possible time that t1 can be is 2 minutes into the past.
func (r MonitorApiGetOrganizationUplinksLossAndLatencyRequest) T1(t1 string) MonitorApiGetOrganizationUplinksLossAndLatencyRequest {
	r.t1 = &t1
	return r
}

// The timespan for which the information will be fetched. If specifying timespan, do not specify parameters t0 and t1. The value must be in seconds and be less than or equal to 5 minutes. The default is 5 minutes.
func (r MonitorApiGetOrganizationUplinksLossAndLatencyRequest) Timespan(timespan float32) MonitorApiGetOrganizationUplinksLossAndLatencyRequest {
	r.timespan = &timespan
	return r
}

// Optional filter for a specific WAN uplink. Valid uplinks are wan1, wan2, wan3, cellular. Default will return all uplinks.
func (r MonitorApiGetOrganizationUplinksLossAndLatencyRequest) Uplink(uplink string) MonitorApiGetOrganizationUplinksLossAndLatencyRequest {
	r.uplink = &uplink
	return r
}

// Optional filter for a specific destination IP. Default will return all destination IPs.
func (r MonitorApiGetOrganizationUplinksLossAndLatencyRequest) Ip(ip string) MonitorApiGetOrganizationUplinksLossAndLatencyRequest {
	r.ip = &ip
	return r
}

func (r MonitorApiGetOrganizationUplinksLossAndLatencyRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
	return r.ApiService.GetOrganizationUplinksLossAndLatencyExecute(r)
}
...
// Execute executes the request
//  @return []map[string]interface{}
func (a *MonitorApiService) GetOrganizationUplinksLossAndLatencyExecute(r MonitorApiGetOrganizationUplinksLossAndLatencyRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MonitorApiService.GetOrganizationUplinksLossAndLatency")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/organizations/{organizationId}/uplinksLossAndLatency"
	localVarPath = strings.Replace(localVarPath, "{"+"organizationId"+"}", url.PathEscape(parameterValueToString(r.organizationId, "organizationId")), -1)
