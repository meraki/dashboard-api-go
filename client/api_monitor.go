...
func (r MonitorApiGetDeviceSwitchPortsStatusesRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return []map[string]interface{}
func (a *MonitorApiService) GetDeviceSwitchPortsStatusesExecute(r MonitorApiGetDeviceSwitchPortsStatusesRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r MonitorApiGetNetworkClientRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return map[string]interface{}
func (a *MonitorApiService) GetNetworkClientExecute(r MonitorApiGetNetworkClientRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r MonitorApiGetNetworkClientsRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return []map[string]interface{}
func (a *MonitorApiService) GetNetworkClientsExecute(r MonitorApiGetNetworkClientsRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r MonitorApiGetNetworkEventsRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return map[string]interface{}
func (a *MonitorApiService) GetNetworkEventsExecute(r MonitorApiGetNetworkEventsRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r MonitorApiGetNetworkEventsEventTypesRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return []map[string]interface{}
func (a *MonitorApiService) GetNetworkEventsEventTypesExecute(r MonitorApiGetNetworkEventsEventTypesRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r MonitorApiGetOrganizationAdaptivePolicyOverviewRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return map[string]interface{}
func (a *MonitorApiService) GetOrganizationAdaptivePolicyOverviewExecute(r MonitorApiGetOrganizationAdaptivePolicyOverviewRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r MonitorApiGetOrganizationCellularGatewayUplinkStatusesRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return []map[string]interface{}
func (a *MonitorApiService) GetOrganizationCellularGatewayUplinkStatusesExecute(r MonitorApiGetOrganizationCellularGatewayUplinkStatusesRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type MonitorApiGetOrganizationWebhookLogsRequest struct {
	ctx context.Context
	ApiService *MonitorApiService
	organizationId string
	t0 *string
...
func (r MonitorApiGetOrganizationWebhookLogsRequest) T0(t0 string) MonitorApiGetOrganizationWebhookLogsRequest {
	r.t0 = &t0
	return r
}

// The end of the timespan for the data. t1 can be a maximum of 31 days after t0.
func (r MonitorApiGetOrganizationWebhookLogsRequest) T1(t1 string) MonitorApiGetOrganizationWebhookLogsRequest {
	r.t1 = &t1
	return r
}

// The timespan for which the information will be fetched. If specifying timespan, do not specify parameters t0 and t1. The value must be in seconds and be less than or equal to 31 days. The default is 1 day.
func (r MonitorApiGetOrganizationWebhookLogsRequest) Timespan(timespan float32) MonitorApiGetOrganizationWebhookLogsRequest {
	r.timespan = &timespan
	return r
}

// The number of entries per page returned. Acceptable range is 3 - 1000. Default is 50.
func (r MonitorApiGetOrganizationWebhookLogsRequest) PerPage(perPage int32) MonitorApiGetOrganizationWebhookLogsRequest {
	r.perPage = &perPage
	return r
}

// A token used by the server to indicate the start of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
func (r MonitorApiGetOrganizationWebhookLogsRequest) StartingAfter(startingAfter string) MonitorApiGetOrganizationWebhookLogsRequest {
	r.startingAfter = &startingAfter
	return r
}

// A token used by the server to indicate the end of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
func (r MonitorApiGetOrganizationWebhookLogsRequest) EndingBefore(endingBefore string) MonitorApiGetOrganizationWebhookLogsRequest {
	r.endingBefore = &endingBefore
	return r
}

// The URL the webhook was sent to
func (r MonitorApiGetOrganizationWebhookLogsRequest) Url(url string) MonitorApiGetOrganizationWebhookLogsRequest {
	r.url = &url
	return r
}

func (r MonitorApiGetOrganizationWebhookLogsRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
...
Return the log of webhook POSTs sent
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param organizationId
 @return MonitorApiGetOrganizationWebhookLogsRequest
*/
func (a *MonitorApiService) GetOrganizationWebhookLogs(ctx context.Context, organizationId string) MonitorApiGetOrganizationWebhookLogsRequest {
	return MonitorApiGetOrganizationWebhookLogsRequest{
		ApiService: a,
		ctx: ctx,
		organizationId: organizationId,
...
// Execute executes the request
//  @return []map[string]interface{}
func (a *MonitorApiService) GetOrganizationWebhookLogsExecute(r MonitorApiGetOrganizationWebhookLogsRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
