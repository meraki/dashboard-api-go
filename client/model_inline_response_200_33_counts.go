...
// InlineResponse20033Counts Counts of currently alerting sensors, aggregated by alerting metric
type InlineResponse20033Counts struct {
	...
	Noise *InlineResponse20033CountsNoise `json:"noise,omitempty"`
...
func NewInlineResponse20033Counts() *InlineResponse20033Counts {
	this := InlineResponse20033Counts{}
	return &this
}
...
func (o *InlineResponse20033Counts) GetNoise() InlineResponse20033CountsNoise {
	if o == nil || isNil(o.Noise) {
		var ret InlineResponse20033CountsNoise
		return ret
	}
	return *o.Noise
}
...
// SetNoise gets a reference to the given InlineResponse20033CountsNoise and assigns it to the Noise field.
...
func (o InlineResponse20033Counts) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20033Counts struct {
	value *InlineResponse20033Counts
	isSet bool
}

func (v NullableInlineResponse20033Counts) Get() *InlineResponse20033Counts {
	return v.value
}

func (v *NullableInlineResponse20033Counts) Set(val *InlineResponse20033Counts) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20033Counts) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20033Counts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20033Counts(val *InlineResponse20033Counts) *NullableInlineResponse20033Counts {
	return &NullableInlineResponse20033Counts{value: val, isSet: true}
}

func (v NullableInlineResponse20033Counts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20033Counts) UnmarshalJSON(src []byte) error {
	v.isSet = true
