...
func (o *InlineResponse20053) GetIsEncrypted() bool {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20053) GetIsEncryptedOk() (*bool, bool) {
	if o == nil || isNil(o.IsEncrypted) {
    return nil, false
	}
...
func (o *InlineResponse20053) HasIsEncrypted() bool {
	if o != nil && !isNil(o.IsEncrypted) {
		return true
	}
...
func (o *InlineResponse20053) SetIsEncrypted(v bool) {
	o.IsEncrypted = &v
}
...
func (o *InlineResponse20053) GetProfileData() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20053) GetProfileDataOk() (*string, bool) {
	if o == nil || isNil(o.ProfileData) {
    return nil, false
	}
...
func (o *InlineResponse20053) HasProfileData() bool {
	if o != nil && !isNil(o.ProfileData) {
		return true
	}
...
func (o *InlineResponse20053) SetProfileData(v string) {
	o.ProfileData = &v
}

// GetProfileIdentifier returns the ProfileIdentifier field value if set, zero value otherwise.
func (o *InlineResponse20053) GetProfileIdentifier() string {
...
// and a boolean to check if the value has been set.
func (o *InlineResponse20053) GetProfileIdentifierOk() (*string, bool) {
	if o == nil || isNil(o.ProfileIdentifier) {
    return nil, false
	}
...
func (o *InlineResponse20053) HasProfileIdentifier() bool {
	if o != nil && !isNil(o.ProfileIdentifier) {
		return true
	}
...
func (o *InlineResponse20053) SetProfileIdentifier(v string) {
