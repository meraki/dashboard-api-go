...
func (r IdpsApiCreateOrganizationSamlIdpRequest) Execute() ([]InlineResponse200118, *http.Response, error) {
...
func (a *IdpsApiService) CreateOrganizationSamlIdpExecute(r IdpsApiCreateOrganizationSamlIdpRequest) ([]InlineResponse200118, *http.Response, error) {
	var (
...
func (r IdpsApiGetOrganizationSamlIdpRequest) Execute() (*InlineResponse200118, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200118
func (a *IdpsApiService) GetOrganizationSamlIdpExecute(r IdpsApiGetOrganizationSamlIdpRequest) (*InlineResponse200118, *http.Response, error) {
	var (
...
func (r IdpsApiGetOrganizationSamlIdpsRequest) Execute() ([]InlineResponse200118, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200118
func (a *IdpsApiService) GetOrganizationSamlIdpsExecute(r IdpsApiGetOrganizationSamlIdpsRequest) ([]InlineResponse200118, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r IdpsApiUpdateOrganizationSamlIdpRequest) Execute() ([]InlineResponse200118, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200118
func (a *IdpsApiService) UpdateOrganizationSamlIdpExecute(r IdpsApiUpdateOrganizationSamlIdpRequest) ([]InlineResponse200118, *http.Response, error) {
	var (
