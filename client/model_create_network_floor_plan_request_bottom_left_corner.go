...
// checks if the CreateNetworkFloorPlanRequestBottomLeftCorner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateNetworkFloorPlanRequestBottomLeftCorner{}
...
func (o CreateNetworkFloorPlanRequestBottomLeftCorner) ToMap() (map[string]interface{}, error) {
