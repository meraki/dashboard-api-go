...
// InlineResponse20017Value1Destination Destination of 'custom' type traffic filter
type InlineResponse20017Value1Destination struct {
...
func NewInlineResponse20017Value1Destination() *InlineResponse20017Value1Destination {
	this := InlineResponse20017Value1Destination{}
	return &this
}
...
func (o InlineResponse20017Value1Destination) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20017Value1Destination struct {
	value *InlineResponse20017Value1Destination
	isSet bool
}

func (v NullableInlineResponse20017Value1Destination) Get() *InlineResponse20017Value1Destination {
	return v.value
}

func (v *NullableInlineResponse20017Value1Destination) Set(val *InlineResponse20017Value1Destination) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20017Value1Destination) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20017Value1Destination) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20017Value1Destination(val *InlineResponse20017Value1Destination) *NullableInlineResponse20017Value1Destination {
	return &NullableInlineResponse20017Value1Destination{value: val, isSet: true}
}

func (v NullableInlineResponse20017Value1Destination) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20017Value1Destination) UnmarshalJSON(src []byte) error {
	v.isSet = true
