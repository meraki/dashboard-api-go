...
func (r StatusApiGetDeviceWirelessStatusRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *StatusApiService) GetDeviceWirelessStatusExecute(r StatusApiGetDeviceWirelessStatusRequest) (map[string]interface{}, *http.Response, error) {
	var (
