...
// NetworksNetworkIdWirelessRfProfilesTwoFourGhzSettings Settings related to 2.4Ghz band
type NetworksNetworkIdWirelessRfProfilesTwoFourGhzSettings struct {
...
func NewNetworksNetworkIdWirelessRfProfilesTwoFourGhzSettings() *NetworksNetworkIdWirelessRfProfilesTwoFourGhzSettings {
	this := NetworksNetworkIdWirelessRfProfilesTwoFourGhzSettings{}
	return &this
}
...
func (o NetworksNetworkIdWirelessRfProfilesTwoFourGhzSettings) MarshalJSON() ([]byte, error) {
...
type NullableNetworksNetworkIdWirelessRfProfilesTwoFourGhzSettings struct {
	value *NetworksNetworkIdWirelessRfProfilesTwoFourGhzSettings
	isSet bool
}

func (v NullableNetworksNetworkIdWirelessRfProfilesTwoFourGhzSettings) Get() *NetworksNetworkIdWirelessRfProfilesTwoFourGhzSettings {
	return v.value
}

func (v *NullableNetworksNetworkIdWirelessRfProfilesTwoFourGhzSettings) Set(val *NetworksNetworkIdWirelessRfProfilesTwoFourGhzSettings) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworksNetworkIdWirelessRfProfilesTwoFourGhzSettings) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworksNetworkIdWirelessRfProfilesTwoFourGhzSettings) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworksNetworkIdWirelessRfProfilesTwoFourGhzSettings(val *NetworksNetworkIdWirelessRfProfilesTwoFourGhzSettings) *NullableNetworksNetworkIdWirelessRfProfilesTwoFourGhzSettings {
	return &NullableNetworksNetworkIdWirelessRfProfilesTwoFourGhzSettings{value: val, isSet: true}
}

func (v NullableNetworksNetworkIdWirelessRfProfilesTwoFourGhzSettings) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworksNetworkIdWirelessRfProfilesTwoFourGhzSettings) UnmarshalJSON(src []byte) error {
	v.isSet = true
