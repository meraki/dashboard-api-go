...
func (r MtuApiGetNetworkSwitchMtuRequest) Execute() (*InlineResponse20075, *http.Response, error) {
...
func (a *MtuApiService) GetNetworkSwitchMtuExecute(r MtuApiGetNetworkSwitchMtuRequest) (*InlineResponse20075, *http.Response, error) {
	var (
...
func (r MtuApiUpdateNetworkSwitchMtuRequest) UpdateNetworkSwitchMtu(updateNetworkSwitchMtu InlineObject122) MtuApiUpdateNetworkSwitchMtuRequest {
