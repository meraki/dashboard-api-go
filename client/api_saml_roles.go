...
func (r SamlRolesApiCreateOrganizationSamlRoleRequest) CreateOrganizationSamlRole(createOrganizationSamlRole InlineObject218) SamlRolesApiCreateOrganizationSamlRoleRequest {
...
func (r SamlRolesApiGetOrganizationSamlRoleRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return map[string]interface{}
func (a *SamlRolesApiService) GetOrganizationSamlRoleExecute(r SamlRolesApiGetOrganizationSamlRoleRequest) (map[string]interface{}, *http.Response, error) {
	var (
...
func (r SamlRolesApiGetOrganizationSamlRolesRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return []map[string]interface{}
func (a *SamlRolesApiService) GetOrganizationSamlRolesExecute(r SamlRolesApiGetOrganizationSamlRolesRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SamlRolesApiUpdateOrganizationSamlRoleRequest) UpdateOrganizationSamlRole(updateOrganizationSamlRole InlineObject219) SamlRolesApiUpdateOrganizationSamlRoleRequest {
	r.updateOrganizationSamlRole = &updateOrganizationSamlRole
	return r
}

func (r SamlRolesApiUpdateOrganizationSamlRoleRequest) Execute() (*InlineResponse200119, *http.Response, error) {
...
func (a *SamlRolesApiService) UpdateOrganizationSamlRoleExecute(r SamlRolesApiUpdateOrganizationSamlRoleRequest) (*InlineResponse200119, *http.Response, error) {
	var (
