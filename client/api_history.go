...
func (r HistoryApiGetNetworkAlertsHistoryRequest) Execute() ([]InlineResponse20010, *http.Response, error) {
...
func (a *HistoryApiService) GetNetworkAlertsHistoryExecute(r HistoryApiGetNetworkAlertsHistoryRequest) ([]InlineResponse20010, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r HistoryApiGetOrganizationSensorReadingsHistoryRequest) Execute() ([]InlineResponse200115, *http.Response, error) {
...
func (a *HistoryApiService) GetOrganizationSensorReadingsHistoryExecute(r HistoryApiGetOrganizationSensorReadingsHistoryRequest) ([]InlineResponse200115, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
