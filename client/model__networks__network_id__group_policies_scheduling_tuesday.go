...
// NetworksNetworkIdGroupPoliciesSchedulingTuesday The schedule object for Tuesday.
type NetworksNetworkIdGroupPoliciesSchedulingTuesday struct {
...
func NewNetworksNetworkIdGroupPoliciesSchedulingTuesday() *NetworksNetworkIdGroupPoliciesSchedulingTuesday {
	this := NetworksNetworkIdGroupPoliciesSchedulingTuesday{}
	return &this
}
...
func (o NetworksNetworkIdGroupPoliciesSchedulingTuesday) MarshalJSON() ([]byte, error) {
...
type NullableNetworksNetworkIdGroupPoliciesSchedulingTuesday struct {
	value *NetworksNetworkIdGroupPoliciesSchedulingTuesday
	isSet bool
}

func (v NullableNetworksNetworkIdGroupPoliciesSchedulingTuesday) Get() *NetworksNetworkIdGroupPoliciesSchedulingTuesday {
	return v.value
}

func (v *NullableNetworksNetworkIdGroupPoliciesSchedulingTuesday) Set(val *NetworksNetworkIdGroupPoliciesSchedulingTuesday) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworksNetworkIdGroupPoliciesSchedulingTuesday) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworksNetworkIdGroupPoliciesSchedulingTuesday) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworksNetworkIdGroupPoliciesSchedulingTuesday(val *NetworksNetworkIdGroupPoliciesSchedulingTuesday) *NullableNetworksNetworkIdGroupPoliciesSchedulingTuesday {
	return &NullableNetworksNetworkIdGroupPoliciesSchedulingTuesday{value: val, isSet: true}
}

func (v NullableNetworksNetworkIdGroupPoliciesSchedulingTuesday) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworksNetworkIdGroupPoliciesSchedulingTuesday) UnmarshalJSON(src []byte) error {
	v.isSet = true
