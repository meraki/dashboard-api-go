...
func (r SamlApiCreateOrganizationSamlIdpRequest) Execute() ([]InlineResponse200118, *http.Response, error) {
...
func (a *SamlApiService) CreateOrganizationSamlIdpExecute(r SamlApiCreateOrganizationSamlIdpRequest) ([]InlineResponse200118, *http.Response, error) {
	var (
...
func (r SamlApiGetOrganizationSamlRequest) Execute() (*InlineResponse200117, *http.Response, error) {
...
func (a *SamlApiService) GetOrganizationSamlExecute(r SamlApiGetOrganizationSamlRequest) (*InlineResponse200117, *http.Response, error) {
	var (
...
func (r SamlApiGetOrganizationSamlIdpRequest) Execute() (*InlineResponse200118, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200118
func (a *SamlApiService) GetOrganizationSamlIdpExecute(r SamlApiGetOrganizationSamlIdpRequest) (*InlineResponse200118, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SamlApiGetOrganizationSamlIdpsRequest) Execute() ([]InlineResponse200118, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200118
func (a *SamlApiService) GetOrganizationSamlIdpsExecute(r SamlApiGetOrganizationSamlIdpsRequest) ([]InlineResponse200118, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r SamlApiUpdateOrganizationSamlRequest) Execute() (*InlineResponse200117, *http.Response, error) {
...
// Execute executes the request
//  @return InlineResponse200117
func (a *SamlApiService) UpdateOrganizationSamlExecute(r SamlApiUpdateOrganizationSamlRequest) (*InlineResponse200117, *http.Response, error) {
	var (
...
func (r SamlApiUpdateOrganizationSamlIdpRequest) Execute() ([]InlineResponse200118, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse200118
func (a *SamlApiService) UpdateOrganizationSamlIdpExecute(r SamlApiUpdateOrganizationSamlIdpRequest) ([]InlineResponse200118, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
