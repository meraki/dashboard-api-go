...
func (r StormControlApiGetNetworkSwitchStormControlRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *StormControlApiService) GetNetworkSwitchStormControlExecute(r StormControlApiGetNetworkSwitchStormControlRequest) (map[string]interface{}, *http.Response, error) {
	var (
