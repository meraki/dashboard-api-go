...
func (r GroupsApiGetNetworkFirmwareUpgradesStagedGroupRequest) Execute() (*InlineResponse20027, *http.Response, error) {
...
func (a *GroupsApiService) GetNetworkFirmwareUpgradesStagedGroupExecute(r GroupsApiGetNetworkFirmwareUpgradesStagedGroupRequest) (*InlineResponse20027, *http.Response, error) {
	var (
...
func (r GroupsApiGetNetworkFirmwareUpgradesStagedGroupsRequest) Execute() ([]InlineResponse20027, *http.Response, error) {
...
// Execute executes the request
//  @return []InlineResponse20027
func (a *GroupsApiService) GetNetworkFirmwareUpgradesStagedGroupsExecute(r GroupsApiGetNetworkFirmwareUpgradesStagedGroupsRequest) ([]InlineResponse20027, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
