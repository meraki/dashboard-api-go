...
func (r CertsApiGetNetworkSmDeviceCertsRequest) Execute() ([]InlineResponse20052, *http.Response, error) {
...
func (a *CertsApiService) GetNetworkSmDeviceCertsExecute(r CertsApiGetNetworkSmDeviceCertsRequest) ([]InlineResponse20052, *http.Response, error) {
	var (
