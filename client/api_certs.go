...
func (r CertsApiGetNetworkSmDeviceCertsRequest) Execute() ([]InlineResponse20046, *http.Response, error) {
...
func (a *CertsApiService) GetNetworkSmDeviceCertsExecute(r CertsApiGetNetworkSmDeviceCertsRequest) ([]InlineResponse20046, *http.Response, error) {
	var (
