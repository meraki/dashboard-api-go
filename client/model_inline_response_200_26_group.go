...
// InlineResponse20026Group The staged upgrade group
type InlineResponse20026Group struct {
...
func (o InlineResponse20026Group) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20026Group struct {
	value *InlineResponse20026Group
	isSet bool
}

func (v NullableInlineResponse20026Group) Get() *InlineResponse20026Group {
	return v.value
}

func (v *NullableInlineResponse20026Group) Set(val *InlineResponse20026Group) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20026Group) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20026Group) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20026Group(val *InlineResponse20026Group) *NullableInlineResponse20026Group {
	return &NullableInlineResponse20026Group{value: val, isSet: true}
}

func (v NullableInlineResponse20026Group) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20026Group) UnmarshalJSON(src []byte) error {
	v.isSet = true
