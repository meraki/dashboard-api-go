...
// OrganizationsOrganizationIdAdaptivePolicyPoliciesSourceGroup The source adaptive policy group (requires one unique attribute)
type OrganizationsOrganizationIdAdaptivePolicyPoliciesSourceGroup struct {
...
func NewOrganizationsOrganizationIdAdaptivePolicyPoliciesSourceGroup() *OrganizationsOrganizationIdAdaptivePolicyPoliciesSourceGroup {
	this := OrganizationsOrganizationIdAdaptivePolicyPoliciesSourceGroup{}
	return &this
}
...
func (o OrganizationsOrganizationIdAdaptivePolicyPoliciesSourceGroup) MarshalJSON() ([]byte, error) {
...
type NullableOrganizationsOrganizationIdAdaptivePolicyPoliciesSourceGroup struct {
	value *OrganizationsOrganizationIdAdaptivePolicyPoliciesSourceGroup
	isSet bool
}

func (v NullableOrganizationsOrganizationIdAdaptivePolicyPoliciesSourceGroup) Get() *OrganizationsOrganizationIdAdaptivePolicyPoliciesSourceGroup {
	return v.value
}

func (v *NullableOrganizationsOrganizationIdAdaptivePolicyPoliciesSourceGroup) Set(val *OrganizationsOrganizationIdAdaptivePolicyPoliciesSourceGroup) {
	v.value = val
	v.isSet = true
}

func (v NullableOrganizationsOrganizationIdAdaptivePolicyPoliciesSourceGroup) IsSet() bool {
	return v.isSet
}

func (v *NullableOrganizationsOrganizationIdAdaptivePolicyPoliciesSourceGroup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrganizationsOrganizationIdAdaptivePolicyPoliciesSourceGroup(val *OrganizationsOrganizationIdAdaptivePolicyPoliciesSourceGroup) *NullableOrganizationsOrganizationIdAdaptivePolicyPoliciesSourceGroup {
	return &NullableOrganizationsOrganizationIdAdaptivePolicyPoliciesSourceGroup{value: val, isSet: true}
}

func (v NullableOrganizationsOrganizationIdAdaptivePolicyPoliciesSourceGroup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrganizationsOrganizationIdAdaptivePolicyPoliciesSourceGroup) UnmarshalJSON(src []byte) error {
	v.isSet = true
