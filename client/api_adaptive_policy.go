...
func (r AdaptivePolicyApiCreateOrganizationAdaptivePolicyAclRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
func (a *AdaptivePolicyApiService) CreateOrganizationAdaptivePolicyAclExecute(r AdaptivePolicyApiCreateOrganizationAdaptivePolicyAclRequest) (map[string]interface{}, *http.Response, error) {
	var (
...
func (r AdaptivePolicyApiGetOrganizationAdaptivePolicyAclRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return map[string]interface{}
func (a *AdaptivePolicyApiService) GetOrganizationAdaptivePolicyAclExecute(r AdaptivePolicyApiGetOrganizationAdaptivePolicyAclRequest) (map[string]interface{}, *http.Response, error) {
	var (
...
func (r AdaptivePolicyApiGetOrganizationAdaptivePolicyAclsRequest) Execute() ([]map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return []map[string]interface{}
func (a *AdaptivePolicyApiService) GetOrganizationAdaptivePolicyAclsExecute(r AdaptivePolicyApiGetOrganizationAdaptivePolicyAclsRequest) ([]map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AdaptivePolicyApiGetOrganizationAdaptivePolicyOverviewRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return map[string]interface{}
func (a *AdaptivePolicyApiService) GetOrganizationAdaptivePolicyOverviewExecute(r AdaptivePolicyApiGetOrganizationAdaptivePolicyOverviewRequest) (map[string]interface{}, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AdaptivePolicyApiUpdateOrganizationAdaptivePolicyAclRequest) Execute() (map[string]interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return map[string]interface{}
func (a *AdaptivePolicyApiService) UpdateOrganizationAdaptivePolicyAclExecute(r AdaptivePolicyApiUpdateOrganizationAdaptivePolicyAclRequest) (map[string]interface{}, *http.Response, error) {
	var (
